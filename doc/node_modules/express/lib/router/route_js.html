...
<main role="main" aria-label="Page node_modules/express/lib/router/route.js">
...
<p>var debug = require(&#39;debug&#39;)(&#39;express:router:route&#39;); var
flatten = require(&#39;array-flatten&#39;); var Layer =
require(&#39;./layer&#39;); var methods = require(&#39;methods&#39;);</p>
...
<p>var slice = Array.prototype.slice; var toString =
...
<p>module.exports = Route;</p>

<p>/**</p>

<pre> Initialize `Route` with the given `path`,

 @param {String} path
 @public
/</pre>

<p>function Route(path) {</p>
...
<pre> Determine if the route handles a given method.
 @private
/</pre>

<p>Route.prototype._handles_method = function _handles_method(method) {</p>

<pre>if (this.methods._all) {
  return true;
}
...
return Boolean(this.methods[name]);</pre>

<p>};</p>

<p>/**</p>

<pre> @return {Array} supported HTTP methods
 @private
/</pre>

<p>Route.prototype._options = function _options() {</p>

<pre>var methods = Object.keys(this.methods);
...
<pre> dispatch req, res into this route
 @private
/</pre>

<p>Route.prototype.dispatch = function dispatch(req, res, done) {</p>
...
<pre> Add a handler for all HTTP verbs to this route.
...
<p>Route.prototype.all = function all() {</p>

<pre>var handles = flatten(slice.call(arguments));
...
<p>methods.forEach(function(method){</p>

<pre>Route.prototype[method] = function(){
