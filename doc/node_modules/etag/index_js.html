...
<main role="main" aria-label="Page node_modules/etag/index.js">
...
<p>var crypto = require(&#39;crypto&#39;) var Stats =
require(&#39;fs&#39;).Stats</p>
...
<p>function entitytag (entity) {</p>

<pre>if (entity.length === 0) {
  // fast-path empty
...
return &#39;&quot;&#39; + len.toString(16) + &#39;-&#39; + hash + &#39;&quot;&#39;</pre>

<p>}</p>

<p>/**</p>

<pre> Create a simple ETag.
...
<p>function etag (entity, options) {</p>
...
<pre> Determine if object is a Stats object.
...
<p>function isstats (obj) {</p>

<pre>// genuine fs.Stats
...
return obj &amp;&amp; typeof obj === &#39;object&#39; &amp;&amp;
  ...
  &#39;size&#39; in obj &amp;&amp; typeof obj.size === &#39;number&#39;</pre>

<p>}</p>

<p>/**</p>

<pre> Generate a tag for a stat.
...
<p>function stattag (stat) {</p>

<pre class="ruby"><span class="ruby-identifier">var</span> <span class="ruby-identifier">mtime</span> = <span class="ruby-identifier">stat</span>.<span class="ruby-identifier">mtime</span>.<span class="ruby-identifier">getTime</span>().<span class="ruby-identifier">toString</span>(<span class="ruby-value">16</span>)
<span class="ruby-identifier">var</span> <span class="ruby-identifier">size</span> = <span class="ruby-identifier">stat</span>.<span class="ruby-identifier">size</span>.<span class="ruby-identifier">toString</span>(<span class="ruby-value">16</span>)
