...
<title>urlencoded.js - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/body-parser/lib/types/urlencoded.js">
...
<p>var bytes = require(&#39;bytes&#39;) var contentType =
require(&#39;content-type&#39;) var createError =
require(&#39;http-errors&#39;) var debug =
require(&#39;debug&#39;)(&#39;body-parser:urlencoded&#39;) var deprecate =
require(&#39;depd&#39;)(&#39;body-parser&#39;) var read =
require(&#39;../read&#39;) var typeis = require(&#39;type-is&#39;)</p>

<p>/**</p>

<pre class="ruby"> <span class="ruby-constant">Module</span> <span class="ruby-identifier">exports</span>.
<span class="ruby-operator">/</span>
</pre>

<p>module.exports = urlencoded</p>

<p>/**</p>

<pre class="ruby"> <span class="ruby-constant">Cache</span> <span class="ruby-identifier">of</span> <span class="ruby-identifier">parser</span> <span class="ruby-identifier">modules</span>.
<span class="ruby-operator">/</span>
</pre>

<p>var parsers = Object.create(null)</p>

<p>/**</p>

<pre> Create a middleware to parse urlencoded bodies.
...
<p>function urlencoded (options) {</p>
...
<pre> Get the extended query parser.

 @param {object} options
/</pre>

<p>function extendedparser (options) {</p>

<pre>var parameterLimit = options.parameterLimit !== undefined
...
<pre> Get the charset of a request.

 @param {object} req
 @api private
/</pre>

<p>function getCharset (req) {</p>
...
<pre> Count the number of parameters, stopping once limit reached
...
<p>function parameterCount (body, limit) {</p>
...
<pre> Get parser for module name dynamically.
...
<p>function parser (name) {</p>

<pre>var mod = parsers[name]
...
return mod.parse</pre>

<p>}</p>

<p>/**</p>

<pre> Get the simple query parser.

 @param {object} options
/</pre>

<p>function simpleparser (options) {</p>
...
<pre> Get the simple type checker.

 @param {string} type
 @return {function}
/</pre>

<p>function typeChecker (type) {</p>

<pre class="ruby"><span class="ruby-keyword">return</span> <span class="ruby-identifier">function</span> <span class="ruby-identifier">checkType</span> (<span class="ruby-identifier">req</span>) {
  <span class="ruby-keyword">return</span> <span class="ruby-constant">Boolean</span>(<span class="ruby-identifier">typeis</span>(<span class="ruby-identifier">req</span>, <span class="ruby-identifier">type</span>))
}
</pre>
