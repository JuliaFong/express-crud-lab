...
<main role="main" aria-label="Page node_modules/iconv-lite/lib/index.js">

<p>“use strict”;</p>

<p>// Some environments don&#39;t have global Buffer (e.g. React Native). //
Solution would be installing npm modules “buffer” and “stream” explicitly.
var Buffer = require(“safer-buffer”).Buffer;</p>

<p>var bomHandling = require(“./bom-handling”),</p>

<pre>iconv = module.exports;</pre>

<p>// All codecs and aliases are kept here, keyed by encoding name/alias. //
They are lazy loaded in `iconv.getCodec` from `encodings/index.js`.
iconv.encodings = null;</p>

<p>// Characters emitted in case of error. iconv.defaultCharUnicode =
&#39;�&#39;; iconv.defaultCharSingleByte = &#39;?&#39;;</p>

<p>// Public API. iconv.encode = function encode(str, encoding, options) {</p>

<pre>str = &quot;&quot; + (str || &quot;&quot;); // Ensure string.
...
return (trail &amp;&amp; trail.length &gt; 0) ? Buffer.concat([res, trail]) : res;</pre>

<p>}</p>

<p>iconv.decode = function decode(buf, encoding, options) {</p>

<pre>if (typeof buf === &#39;string&#39;) {
...
return trail ? (res + trail) : res;</pre>

<p>}</p>

<p>iconv.encodingExists = function encodingExists(enc) {</p>
...
<p>// Legacy aliases to convert functions iconv.toEncoding = iconv.encode;
iconv.fromEncoding = iconv.decode;</p>

<p>// Search for a codec in iconv.encodings. Cache codec data in
iconv._codecDataCache. iconv._codecDataCache = {}; iconv.getCodec =
function getCodec(encoding) {</p>

<pre>if (!iconv.encodings)
...
<p>iconv._canonicalizeEncoding = function(encoding) {</p>

<pre>// Canonicalize encoding name: strip all non-alphanumeric chars and appended year.
return (&#39;&#39;+encoding).toLowerCase().replace(/:\d{4}$|[^0-9a-z]/g, &quot;&quot;);</pre>

<p>}</p>

<p>iconv.getEncoder = function getEncoder(encoding, options) {</p>

<pre>var codec = iconv.getCodec(encoding),
...
<p>iconv.getDecoder = function getDecoder(encoding, options) {</p>
...
<p>// Load extensions in Node. All of them are omitted in Browserify build via
&#39;browser&#39; field in package.json. var nodeVer = typeof process !==
&#39;undefined&#39; &amp;&amp; process.versions &amp;&amp;
process.versions.node; if (nodeVer) {</p>

<pre>// Load streaming support in Node v0.10+
...
require(&quot;./extend-node&quot;)(iconv);</pre>

<p>}</p>

<p>if (“Ā” != “u0100”) {</p>

<pre class="ruby"><span class="ruby-identifier">console</span>.<span class="ruby-identifier">error</span>(<span class="ruby-string">&quot;iconv-lite warning: javascript files use encoding different from utf-8. See https://github.com/ashtuchkin/iconv-lite/wiki/Javascript-source-file-encodings for more info.&quot;</span>);
</pre>
