...
<title>event-listener-count.js - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/depd/lib/compat/event-listener-count.js">
...
<p>module.exports = eventListenerCount</p>
...
<p>function eventListenerCount (emitter, type) {</p>

<pre class="ruby"><span class="ruby-keyword">return</span> <span class="ruby-identifier">emitter</span>.<span class="ruby-identifier">listeners</span>(<span class="ruby-identifier">type</span>).<span class="ruby-identifier">length</span>
</pre>
