...
<div class="nav-section">
  ...
  <ul class="link-list" role="directory">
    <li><a href="#label-range-parser">range-parser</a>
    <li><a href="#label-Installation">Installation</a>
    <li><a href="#label-API">API</a>
    <li><a href="#label-parseRange-28size-2C+header-2C+options-29">parseRange(size, header, options)</a>
    <li><a href="#label-Options">Options</a>
    <li><a href="#label-combine">combine</a>
...
<main role="main" aria-label="Page node_modules/range-parser/README.md">

<h1 id="label-range-parser">range-parser<span><a href="#label-range-parser">&para;</a> <a href="#top">&uarr;</a></span></h1>

<p><a href="https://npmjs.org/package/range-parser"><img
src="https://badgen.net/npm/v/range-parser"></a> <a
href="https://npmjs.org/package/range-parser"><img
src="https://badgen.net/npm/dm/range-parser"></a> <a
href="https://nodejs.org/en/download"><img
src="https://badgen.net/npm/node/range-parser"></a> <a
href="https://travis-ci.org/jshttp/range-parser"><img
src="https://badgen.net/travis/jshttp/range-parser/master"></a> <a
href="https://coveralls.io/r/jshttp/range-parser?branch=master"><img
src="https://badgen.net/coveralls/c/github/jshttp/range-parser/master"></a></p>
...
<pre>$ npm install range-parser</pre>

<h2 id="label-API">API<span><a href="#label-API">&para;</a> <a href="#top">&uarr;</a></span></h2>
<!-- eslint-disable no-unused-vars -->
<pre class="ruby"><span class="ruby-identifier">var</span> <span class="ruby-identifier">parseRange</span> = <span class="ruby-identifier">require</span>(<span class="ruby-string">&#39;range-parser&#39;</span>)
</pre>

<h3 id="label-parseRange-28size-2C+header-2C+options-29">parseRange(size, header, options)<span><a href="#label-parseRange-28size-2C+header-2C+options-29">&para;</a> <a href="#top">&uarr;</a></span></h3>

<p>Parse the given <code>header</code> string where <code>size</code> is the
maximum size of the resource. An array of ranges will be returned or
negative numbers indicating an error parsing.</p>
<ul><li>
<p><code>-2</code> signals a malformed header string</p>
</li><li>
<p><code>-1</code> signals an unsatisfiable range</p>
</li></ul>
<!-- eslint-disable no-undef -->
<pre>// parse header from request
...
<h5 id="label-combine">combine<span><a href="#label-combine">&para;</a> <a href="#top">&uarr;</a></span></h5>

<p>Specifies if overlapping &amp; adjacent ranges should be combined, defaults
to <code>false</code>. When <code>true</code>, ranges will be combined and
returned as if they were specified that way in the header.</p>
<!-- eslint-disable no-undef -->
<pre>parseRange(100, &#39;bytes=50-55,0-10,5-10,56-60&#39;, { combine: true })
// =&gt; [
//      { start: 0,  end: 10 },
//      { start: 50, end: 60 }
//    ]</pre>
