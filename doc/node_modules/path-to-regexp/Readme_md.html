...
<div class="nav-section">
  ...
  <ul class="link-list" role="directory">
    <li><a href="#label-Path-to-RegExp">Path-to-RegExp</a>
    <li><a href="#label-Usage">Usage</a>
    <li><a href="#label-pathToRegexp-28path-2C+keys-2C+options-29">pathToRegexp(path, keys, options)</a>
    <li><a href="#label-Live+Demo">Live Demo</a>
...
<main role="main" aria-label="Page node_modules/path-to-regexp/Readme.md">

<h1 id="label-Path-to-RegExp">Path-to-RegExp<span><a href="#label-Path-to-RegExp">&para;</a> <a href="#top">&uarr;</a></span></h1>

<p>Turn an Express-style path string such as <code>/user/:name</code> into a
regular expression.</p>

<p><strong>Note:</strong> This is a legacy branch. You should upgrade to
<code>1.x</code>.</p>

<h2 id="label-Usage">Usage<span><a href="#label-Usage">&para;</a> <a href="#top">&uarr;</a></span></h2>

<pre class="ruby"><span class="ruby-identifier">var</span> <span class="ruby-identifier">pathToRegexp</span> = <span class="ruby-identifier">require</span>(<span class="ruby-string">&#39;path-to-regexp&#39;</span>);
</pre>

<h3 id="label-pathToRegexp-28path-2C+keys-2C+options-29">pathToRegexp(path, keys, options)<span><a href="#label-pathToRegexp-28path-2C+keys-2C+options-29">&para;</a> <a href="#top">&uarr;</a></span></h3>
<ul><li>
<p><strong>path</strong> A string in the express format, an array of such
strings, or a regular expression</p>
</li><li>
<p><strong>keys</strong> An array to be populated with the keys present in the
url. Once the function completes, this will be an array of strings.</p>
</li><li>
<p><strong>options</strong></p>
</li><li>
<p><strong>options.sensitive</strong> Defaults to false, set this to true to
make routes case sensitive</p>
</li><li>
<p><strong>options.strict</strong> Defaults to false, set this to true to make
the trailing slash matter.</p>
</li><li>
<p><strong>options.end</strong> Defaults to true, set this to false to only
match the prefix of the URL.</p>
</li></ul>
...
<h2 id="label-Live+Demo">Live Demo<span><a href="#label-Live+Demo">&para;</a> <a href="#top">&uarr;</a></span></h2>

<p>You can see a live demo of this library in use at <a
href="http://forbeslindesay.github.com/express-route-tester/">express-route-tester</a>.</p>
