...
<main role="main" aria-label="Page node_modules/on-finished/index.js">
...
<p>module.exports = onFinished module.exports.isFinished = isFinished</p>
...
<p>var first = require(&#39;ee-first&#39;)</p>
...
<p>var defer = typeof setImmediate === &#39;function&#39;</p>

<pre>? setImmediate
: function(fn){ process.nextTick(fn.bind.apply(fn, arguments)) }</pre>

<p>/**</p>

<pre> Invoke callback when the response has finished, useful for
...
<p>function onFinished(msg, listener) {</p>

<pre>if (isFinished(msg) !== false) {
...
<pre> Determine if message is already finished.
...
<p>function isFinished(msg) {</p>

<pre>var socket = msg.socket
...
<pre> Attach a finished listener to the message.
...
<p>function attachFinishedListener(msg, callback) {</p>
...
<pre> Attach the listener to the message.
...
<p>function attachListener(msg, listener) {</p>

<pre>var attached = msg.__onFinished
...
attached.queue.push(listener)</pre>

<p>}</p>

<p>/**</p>

<pre> Create listener on message.
...
<p>function createListener(msg) {</p>

<pre>function listener(err) {
...
<pre> Patch ServerResponse.prototype.assignSocket for node.js 0.8.
...
<p>function patchAssignSocket(res, callback) {</p>

<pre>var assignSocket = res.assignSocket
