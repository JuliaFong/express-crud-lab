...
<title>mediaType.js - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/negotiator/lib/mediaType.js">
...
<p>module.exports = preferredMediaTypes; module.exports.preferredMediaTypes =
preferredMediaTypes;</p>
...
<p>var simpleMediaTypeRegExp = /^<a
href=“^s/;”>s*(</a>+)/([^;s]+)s*(?:;(.*))?$/;</p>

<p>/**</p>

<pre> Parse the Accept header.
 @private
/</pre>

<p>function parseAccept(accept) {</p>

<pre>var accepts = splitMediaTypes(accept);
...
<pre> Parse a media type from the Accept header.
 @private
/</pre>

<p>function parseMediaType(str, i) {</p>

<pre>var match = simpleMediaTypeRegExp.exec(str);
...
<pre> Get the priority of a media type.
 @private
/</pre>

<p>function getMediaTypePriority(type, accepted, index) {</p>

<pre>var priority = {o: -1, q: 0, s: 0};
...
<pre> Get the specificity of the media type.
 @private
/</pre>

<p>function specify(type, spec, index) {</p>

<pre>var p = parseMediaType(type);
var s = 0;
...
<pre> Get the preferred media types from an Accept header.
 @public
/</pre>

<p>function preferredMediaTypes(accept, provided) {</p>

<pre>// RFC 2616 sec 14.2: no header =   *
...
<pre> Compare two specs.
 @private
/</pre>

<p>function compareSpecs(a, b) {</p>
...
<pre> Get full type string.
 @private
/</pre>

<p>function getFullType(spec) {</p>

<pre class="ruby"><span class="ruby-keyword">return</span> <span class="ruby-identifier">spec</span>.<span class="ruby-identifier">type</span> <span class="ruby-operator">+</span> <span class="ruby-string">&#39;/&#39;</span> <span class="ruby-operator">+</span> <span class="ruby-identifier">spec</span>.<span class="ruby-identifier">subtype</span>;
</pre>
...
<pre> Check if a spec has any quality.
 @private
/</pre>

<p>function isQuality(spec) {</p>

<pre class="ruby"><span class="ruby-keyword">return</span> <span class="ruby-identifier">spec</span>.<span class="ruby-identifier">q</span> <span class="ruby-operator">&gt;</span> <span class="ruby-value">0</span>;
</pre>
...
<pre> Count the number of quotes in a string.
 @private
/</pre>

<p>function quoteCount(string) {</p>
...
<pre> Split a key value pair.
 @private
/</pre>

<p>function splitKeyValuePair(str) {</p>

<pre>var index = str.indexOf(&#39;=&#39;);
var key;
var val;
...
<pre> Split an Accept header into media types.
 @private
/</pre>

<p>function splitMediaTypes(accept) {</p>

<pre>var accepts = accept.split(&#39;,&#39;);
...
<pre> Split a string of parameters.
 @private
/</pre>

<p>function splitParameters(str) {</p>

<pre>var parameters = str.split(&#39;;&#39;);
