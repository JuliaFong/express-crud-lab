...
<div class="nav-section">
  ...
  <ul class="link-list" role="directory">
    <li><a href="#label-vary">vary</a>
    <li><a href="#label-Installation">Installation</a>
    <li><a href="#label-API">API</a>
    <li><a href="#label-vary-28res-2C+field-29">vary(res, field)</a>
    <li><a href="#label-vary.append-28header-2C+field-29">vary.append(header, field)</a>
    <li><a href="#label-Examples">Examples</a>
    <li><a href="#label-Updating+the+Vary+header+when+content+is+based+on+it">Updating the Vary header when content is based on it</a>
...
<main role="main" aria-label="Page node_modules/vary/README.md">

<h1 id="label-vary">vary<span><a href="#label-vary">&para;</a> <a href="#top">&uarr;</a></span></h1>

<p><a href="https://npmjs.org/package/vary"><img
src="https://img.shields.io/npm/v/vary.svg"></a> <a
href="https://npmjs.org/package/vary"><img
src="https://img.shields.io/npm/dm/vary.svg"></a> <a
href="https://nodejs.org/en/download"><img
src="https://img.shields.io/node/v/vary.svg"></a> <a
href="https://travis-ci.org/jshttp/vary"><img
src="https://img.shields.io/travis/jshttp/vary/master.svg"></a> <a
href="https://coveralls.io/r/jshttp/vary"><img
src="https://img.shields.io/coveralls/jshttp/vary/master.svg"></a></p>
...
<pre>$ npm install vary</pre>

<h2 id="label-API">API<span><a href="#label-API">&para;</a> <a href="#top">&uarr;</a></span></h2>
<!-- eslint-disable no-unused-vars -->
<pre class="ruby"><span class="ruby-identifier">var</span> <span class="ruby-identifier">vary</span> = <span class="ruby-identifier">require</span>(<span class="ruby-string">&#39;vary&#39;</span>)
</pre>

<h3 id="label-vary-28res-2C+field-29">vary(res, field)<span><a href="#label-vary-28res-2C+field-29">&para;</a> <a href="#top">&uarr;</a></span></h3>

<p>Adds the given header <code>field</code> to the <code>Vary</code> response
header of <code>res</code>. This can be a string of a single field, a
string of a valid <code>Vary</code> header, or an array of multiple fields.</p>

<p>This will append the header if not already listed, otherwise leaves it
listed in the current location.</p>
<!-- eslint-disable no-undef -->
<pre>// Append &quot;Origin&quot; to the Vary header of the response
vary(res, &#39;Origin&#39;)</pre>

<h3 id="label-vary.append-28header-2C+field-29">vary.append(header, field)<span><a href="#label-vary.append-28header-2C+field-29">&para;</a> <a href="#top">&uarr;</a></span></h3>

<p>Adds the given header <code>field</code> to the <code>Vary</code> response
header string <code>header</code>. This can be a string of a single field,
a string of a valid <code>Vary</code> header, or an array of multiple
fields.</p>

<p>This will append the header if not already listed, otherwise leaves it
listed in the current location. The new header string is returned.</p>
<!-- eslint-disable no-undef -->
<pre>// Get header string appending &quot;Origin&quot; to &quot;Accept, User-Agent&quot;
vary.append(&#39;Accept, User-Agent&#39;, &#39;Origin&#39;)</pre>

<h2 id="label-Examples">Examples<span><a href="#label-Examples">&para;</a> <a href="#top">&uarr;</a></span></h2>

<h3 id="label-Updating+the+Vary+header+when+content+is+based+on+it">Updating the Vary header when content is based on it<span><a href="#label-Updating+the+Vary+header+when+content+is+based+on+it">&para;</a> <a href="#top">&uarr;</a></span></h3>
