...
<main role="main" aria-label="Page node_modules/raw-body/index.d.ts">

<p>import { Readable } from &#39;stream&#39;;</p>

<p>declare namespace getRawBody {</p>

<pre>export type Encoding = string | true;
...
<pre> Gets the entire buffer of a stream either as a `Buffer` or a string.
 Validates the stream&#39;s length against an expected length and maximum
 limit. Ideal for parsing request bodies.
/</pre>

<p>declare function getRawBody(</p>

<pre>stream: Readable,
callback: (err: getRawBody.RawBodyError, body: Buffer) =&gt; void</pre>
...
callback: (err: getRawBody.RawBodyError, body: string) =&gt; void</pre>
...
<pre>stream: Readable,
options: (getRawBody.Options &amp; { encoding: getRawBody.Encoding }) | getRawBody.Encoding</pre>
...
<pre>stream: Readable,
options?: getRawBody.Options</pre>

<p>): Promise&lt;Buffer&gt;;</p>

<p>export = getRawBody;</p>
</main>
