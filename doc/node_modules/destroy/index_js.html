...
<main role="main" aria-label="Page node_modules/destroy/index.js">
...
<p>var ReadStream = require(&#39;fs&#39;).ReadStream var Stream =
require(&#39;stream&#39;)</p>
...
<p>module.exports = destroy</p>

<p>/**</p>

<pre> Destroy a stream.

 @param {object} stream
 @public
/</pre>

<p>function destroy(stream) {</p>

<pre>if (stream instanceof ReadStream) {
...
<pre> Destroy a ReadStream.

 @param {object} stream
 @private
/</pre>

<p>function destroyReadStream(stream) {</p>
...
<pre> On open handler to close stream.
 @private
/</pre>

<p>function onOpenClose() {</p>

<pre>if (typeof this.fd === &#39;number&#39;) {
