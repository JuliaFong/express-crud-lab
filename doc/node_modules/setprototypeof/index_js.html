...
<main role="main" aria-label="Page node_modules/setprototypeof/index.js">

<p>&#39;use strict&#39;</p>

<pre>eslint no-proto: 0</pre>

<p>module.exports = Object.setPrototypeOf || ({ __proto__: [] } instanceof
Array ? setProtoOf : mixinProperties)</p>

<p>function setProtoOf (obj, proto) {</p>

<pre class="ruby"><span class="ruby-identifier">obj</span>.<span class="ruby-identifier">__proto__</span> = <span class="ruby-identifier">proto</span>
<span class="ruby-keyword">return</span> <span class="ruby-identifier">obj</span>
</pre>

<p>}</p>

<p>function mixinProperties (obj, proto) {</p>

<pre>for (var prop in proto) {
