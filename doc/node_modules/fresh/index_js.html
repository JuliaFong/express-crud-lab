...
<main role="main" aria-label="Page node_modules/fresh/index.js">
...
<pre> RegExp to check for no-cache token in Cache-Control.
 @private
/</pre>

<p>var CACHE_CONTROL_NO_CACHE_REGEXP = /(?:^|,)s*?no-caches*?(?:,|$)/</p>
...
<p>module.exports = fresh</p>

<p>/**</p>

<pre> Check freshness of the response using request and response headers.
...
<p>function fresh (reqHeaders, resHeaders) {</p>
