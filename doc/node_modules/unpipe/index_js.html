...
<main role="main" aria-label="Page node_modules/unpipe/index.js">
...
<p>module.exports = unpipe</p>

<p>/**</p>

<pre> Determine if there are Node.js pipe-like data listeners.
 @private
/</pre>

<p>function hasPipeDataListeners(stream) {</p>

<pre>var listeners = stream.listeners(&#39;data&#39;)
...
<pre> Unpipe a stream from all destinations.

 @param {object} stream
 @public
/</pre>

<p>function unpipe(stream) {</p>
