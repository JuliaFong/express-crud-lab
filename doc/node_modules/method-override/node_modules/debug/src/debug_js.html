...
<title>debug.js - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/method-override/node_modules/debug/src/debug.js">

<pre>This is the common logic for both the Node.js and web browser
implementations of `debug()`.

Expose `debug()` as the module.</pre>

<p>exports = module.exports = createDebug.debug = <a
href="'default'">createDebug</a> = createDebug; exports.coerce = coerce;
exports.disable = disable; exports.enable = enable; exports.enabled =
enabled; exports.humanize = require(&#39;ms&#39;);</p>

<pre> Active `debug` instances.
/</pre>

<p>exports.instances = [];</p>

<p>/**</p>

<pre> The currently active debug mode names, and names to skip.
/</pre>

<p>exports.names = []; exports.skips = [];</p>

<p>/**</p>

<pre> Map of special &quot;%n&quot; handling functions, for the debug &quot;format&quot; argument.

 Valid key names are a single, lower or upper-case letter, i.e. &quot;n&quot; and &quot;N&quot;.
/</pre>

<p>exports.formatters = {};</p>
...
<p>function selectColor(namespace) {</p>
...
return exports.colors[Math.abs(hash) % exports.colors.length];</pre>

<p>}</p>

<p>/**</p>

<pre> Create a debugger with the given `namespace`.
...
<p>function createDebug(namespace) {</p>
...
<pre>var index = exports.instances.indexOf(this);
if (index !== -1) {
...
<pre> Enables a debug mode by namespaces. This can include modes
...
<p>function enable(namespaces) {</p>

<pre>exports.save(namespaces);
...
<pre> Disable debug output.

 @api public
/</pre>

<p>function disable() {</p>

<pre class="ruby"><span class="ruby-identifier">exports</span>.<span class="ruby-identifier">enable</span>(<span class="ruby-string">&#39;&#39;</span>);
</pre>
...
<pre> Returns true if the given mode name is enabled, false otherwise.
...
<p>function enabled(name) {</p>

<pre>if (name[name.length - 1] === &#39;*&#39;) {
  return true;
}
var i, len;
...
<p>function coerce(val) {</p>

<pre>if (val instanceof Error) return val.stack || val.message;
return val;</pre>
