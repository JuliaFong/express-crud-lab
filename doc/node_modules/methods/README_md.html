...
<main role="main" aria-label="Page node_modules/methods/README.md">

<h1 id="label-Methods">Methods<span><a href="#label-Methods">&para;</a> <a href="#top">&uarr;</a></span></h1>

<p><a href="https://npmjs.org/package/methods"><img
src="https://img.shields.io/npm/v/methods.svg?style=flat"></a> <a
href="https://npmjs.org/package/methods"><img
src="https://img.shields.io/npm/dm/methods.svg?style=flat"></a> <a
href="https://nodejs.org/en/download/"><img
src="https://img.shields.io/node/v/methods.svg?style=flat"></a> <a
href="https://travis-ci.org/jshttp/methods"><img
src="https://img.shields.io/travis/jshttp/methods.svg?style=flat"></a> <a
href="https://coveralls.io/r/jshttp/methods?branch=master"><img
src="https://img.shields.io/coveralls/jshttp/methods.svg?style=flat"></a></p>

<p>HTTP verbs that Node.js core&#39;s HTTP parser supports.</p>

<p>This module provides an export that is just like <code>http.METHODS</code>
from Node.js core, with the following differences:</p>
<ul><li>
<p>All method names are lower-cased.</p>
</li><li>
<p>Contains a fallback list of methods for Node.js versions that do not have a
<code>http.METHODS</code> export (0.10 and lower).</p>
</li><li>
<p>Provides the fallback list when using tools like <code>browserify</code>
without pulling in the <code>http</code> shim module.</p>
</li></ul>

<h2 id="label-Install">Install<span><a href="#label-Install">&para;</a> <a href="#top">&uarr;</a></span></h2>

<pre>$ npm install methods</pre>

<h2 id="label-API">API<span><a href="#label-API">&para;</a> <a href="#top">&uarr;</a></span></h2>

<pre class="ruby"><span class="ruby-identifier">var</span> <span class="ruby-identifier">methods</span> = <span class="ruby-identifier">require</span>(<span class="ruby-string">&#39;methods&#39;</span>)
</pre>

<h3 id="label-methods">methods<span><a href="#label-methods">&para;</a> <a href="#top">&uarr;</a></span></h3>

<p>This is an array of lower-cased method names that Node.js supports. If
Node.js provides the <code>http.METHODS</code> export, then this is the
