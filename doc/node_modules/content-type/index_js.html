...
<main role="main" aria-label="Page node_modules/content-type/index.js">
...
<pre> RegExp to match *( &quot;;&quot; parameter ) in RFC 7231 sec 3.1.1.1
...
<p>var PARAM_REGEXP = /; *([!#$%&amp;&#39;*+.^_`|~0-9A-Za-z-]+) *= *(“(?:[<a
href=”u000bu0020-u00ff“>u000bu0020u0021u0023-u005bu005d-u007eu0080-u00ff]|\</a>)*”|[!#$%&amp;&#39;*+.^_`|~0-9A-Za-z-]+)
g var TEXT_REGEXP = /^[u000bu0020-u007eu0080-u00ff]+$/ var TOKEN_REGEXP =
/^[!#$%&amp;&#39;*+.^_`|~0-9A-Za-z-]+$/</p>

<p>/**</p>

<pre> RegExp to match quoted-pair in RFC 7230 sec 3.2.6

 quoted-pair = &quot;\&quot; ( HTAB / SP / VCHAR / obs-text )
 obs-text    = %x80-FF
/</pre>

<p>var QESC_REGEXP = /\([u000bu0020-u00ff])/g</p>

<p>/**</p>

<pre> RegExp to match chars that must be quoted-pair in RFC 7230 sec 3.2.6
/</pre>

<p>var QUOTE_REGEXP = /([\“])/g</p>

<p>/**</p>

<pre> RegExp to match type in RFC 7231 sec 3.1.1.1
...
<p>var TYPE_REGEXP = /^[!#$%&amp;&#39;*+.^<a
href="!#$%&'*+.^_`|~0-9A-Za-z-">_`|~0-9A-Za-z-]+/</a>+$/</p>
...
<p>exports.format = format exports.parse = parse</p>

<p>/**</p>

<pre> Format object to media type.
...
<p>function format (obj) {</p>

<pre>if (!obj || typeof obj !== &#39;object&#39;) {
...
<pre> Parse media type to object.
...
<pre> Get content-type from req/res objects.
...
<p>function getcontenttype (obj) {</p>
...
<pre> Quote a string if necessary.
...
<p>function qstring (val) {</p>

<pre>var str = String(val)
...
return &#39;&quot;&#39; + str.replace(QUOTE_REGEXP, &#39;\\$1&#39;) + &#39;&quot;&#39;</pre>

<p>}</p>

<p>/**</p>

<pre> Class to represent a content type.
 @private
/</pre>

<p>function ContentType (type) {</p>

<pre class="ruby"><span class="ruby-identifier">this</span>.<span class="ruby-identifier">parameters</span> = <span class="ruby-constant">Object</span>.<span class="ruby-identifier">create</span>(<span class="ruby-identifier">null</span>)
<span class="ruby-identifier">this</span>.<span class="ruby-identifier">type</span> = <span class="ruby-identifier">type</span>
</pre>
