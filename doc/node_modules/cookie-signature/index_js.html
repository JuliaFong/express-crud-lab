...
<main role="main" aria-label="Page node_modules/cookie-signature/index.js">
...
<pre> Sign the given `val` with `secret`.
...
<p>exports.sign = function(val, secret){</p>

<pre>if (&#39;string&#39; != typeof val) throw new TypeError(&quot;Cookie value must be provided as a string.&quot;);
...
<pre> Unsign and decode the given `val` with `secret`,
...
<p>exports.unsign = function(val, secret){</p>

<pre>if (&#39;string&#39; != typeof val) throw new TypeError(&quot;Signed cookie string must be provided.&quot;);
if (&#39;string&#39; != typeof secret) throw new TypeError(&quot;Secret string must be provided.&quot;);
var str = val.slice(0, val.lastIndexOf(&#39;.&#39;))
  , mac = exports.sign(str, secret);

return sha1(mac) == sha1(val) ? str : false;</pre>
...
<p>function sha1(str){</p>

<pre class="ruby"><span class="ruby-keyword">return</span> <span class="ruby-identifier">crypto</span>.<span class="ruby-identifier">createHash</span>(<span class="ruby-string">&#39;sha1&#39;</span>).<span class="ruby-identifier">update</span>(<span class="ruby-identifier">str</span>).<span class="ruby-identifier">digest</span>(<span class="ruby-string">&#39;hex&#39;</span>);
</pre>
