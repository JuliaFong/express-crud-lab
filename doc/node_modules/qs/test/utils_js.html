...
<main role="main" aria-label="Page node_modules/qs/test/utils.js">

<p>&#39;use strict&#39;;</p>

<p>var test = require(&#39;tape&#39;); var inspect =
require(&#39;object-inspect&#39;); var SaferBuffer =
require(&#39;safer-buffer&#39;).Buffer; var forEach =
require(&#39;for-each&#39;); var utils = require(&#39;../lib/utils&#39;);</p>

<p>test(&#39;merge()&#39;, function (t) {</p>

<pre>t.deepEqual(utils.merge(null, true), [null, true], &#39;merges true into null&#39;);
...
<p>test(&#39;assign()&#39;, function (t) {</p>

<pre class="ruby"><span class="ruby-identifier">var</span> <span class="ruby-identifier">target</span> = { <span class="ruby-identifier">a</span><span class="ruby-operator">:</span> <span class="ruby-value">1</span>, <span class="ruby-identifier">b</span><span class="ruby-operator">:</span> <span class="ruby-value">2</span> };
<span class="ruby-identifier">var</span> <span class="ruby-identifier">source</span> = { <span class="ruby-identifier">b</span><span class="ruby-operator">:</span> <span class="ruby-value">3</span>, <span class="ruby-identifier">c</span><span class="ruby-operator">:</span> <span class="ruby-value">4</span> };
<span class="ruby-identifier">var</span> <span class="ruby-identifier">result</span> = <span class="ruby-identifier">utils</span>.<span class="ruby-identifier">assign</span>(<span class="ruby-identifier">target</span>, <span class="ruby-identifier">source</span>);

<span class="ruby-identifier">t</span>.<span class="ruby-identifier">equal</span>(<span class="ruby-identifier">result</span>, <span class="ruby-identifier">target</span>, <span class="ruby-string">&#39;returns the target&#39;</span>);
<span class="ruby-identifier">t</span>.<span class="ruby-identifier">deepEqual</span>(<span class="ruby-identifier">target</span>, { <span class="ruby-identifier">a</span><span class="ruby-operator">:</span> <span class="ruby-value">1</span>, <span class="ruby-identifier">b</span><span class="ruby-operator">:</span> <span class="ruby-value">3</span>, <span class="ruby-identifier">c</span><span class="ruby-operator">:</span> <span class="ruby-value">4</span> }, <span class="ruby-string">&#39;target and source are merged&#39;</span>);
<span class="ruby-identifier">t</span>.<span class="ruby-identifier">deepEqual</span>(<span class="ruby-identifier">source</span>, { <span class="ruby-identifier">b</span><span class="ruby-operator">:</span> <span class="ruby-value">3</span>, <span class="ruby-identifier">c</span><span class="ruby-operator">:</span> <span class="ruby-value">4</span> }, <span class="ruby-string">&#39;source is untouched&#39;</span>);
...
<p>test(&#39;combine()&#39;, function (t) {</p>

<pre>t.test(&#39;both arrays&#39;, function (st) {
    var a = [1];
    var b = [2];
...
<p>test(&#39;isBuffer()&#39;, function (t) {</p>

<pre>forEach([null, undefined, true, false, &#39;&#39;, &#39;abc&#39;, 42, 0, NaN, {}, [], function () {}, /a/g], function (x) {
