...
<main role="main" aria-label="Page node_modules/body-parser/lib/types/json.js">
...
require(&#39;debug&#39;)(&#39;body-parser:json&#39;) var read =
...
<p>module.exports = json</p>

<p>/**</p>

<pre> RegExp to match the first non-space in a string.
...
<p>var FIRST_CHAR_REGEXP = /^[x20x09x0ax0d]*(.)/ // eslint-disable-line
no-control-regex</p>

<p>/**</p>

<pre> Create a middleware to parse JSON bodies.
...
<pre> Create strict violation syntax error matching native error.
...
<p>function createStrictSyntaxError (str, char) {</p>

<pre>var index = str.indexOf(char)
...
<pre> Get the first non-whitespace character in a string.
...
<p>function firstchar (str) {</p>

<pre class="ruby"><span class="ruby-keyword">return</span> <span class="ruby-constant">FIRST_CHAR_REGEXP</span>.<span class="ruby-identifier">exec</span>(<span class="ruby-identifier">str</span>)[<span class="ruby-value">1</span>]
</pre>
...
<pre> Normalize a SyntaxError for JSON.parse.
...
<p>function normalizeJsonSyntaxError (error, obj) {</p>

<pre>var keys = Object.getOwnPropertyNames(error)
