...
<title>language.js - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/negotiator/lib/language.js">
...
<p>module.exports = preferredLanguages; module.exports.preferredLanguages =
preferredLanguages;</p>
...
<p>var simpleLanguageRegExp = /^<a
href=“^s-;”>s*(</a>+)(?:-([^s;]+))?s*(?:;(.*))?$/;</p>

<p>/**</p>

<pre> Parse the Accept-Language header.
 @private
/</pre>

<p>function parseAcceptLanguage(accept) {</p>
...
<pre> Parse a language from the Accept-Language header.
 @private
/</pre>

<p>function parseLanguage(str, i) {</p>

<pre>var match = simpleLanguageRegExp.exec(str);
...
<pre> Get the priority of a language.
 @private
/</pre>

<p>function getLanguagePriority(language, accepted, index) {</p>
...
<pre> Get the specificity of the language.
 @private
/</pre>

<p>function specify(language, spec, index) {</p>

<pre>var p = parseLanguage(language)
if (!p) return null;
var s = 0;
...
<pre> Get the preferred languages from an Accept-Language header.
 @public
/</pre>

<p>function preferredLanguages(accept, provided) {</p>

<pre>// RFC 2616 sec 14.4: no header = *
...
<pre> Get full language string.
 @private
/</pre>

<p>function getFullLanguage(spec) {</p>

<pre class="ruby"><span class="ruby-keyword">return</span> <span class="ruby-identifier">spec</span>.<span class="ruby-identifier">full</span>;
</pre>
