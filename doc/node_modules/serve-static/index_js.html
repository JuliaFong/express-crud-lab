...
<main role="main" aria-label="Page node_modules/serve-static/index.js">
...
<p>var encodeUrl = require(&#39;encodeurl&#39;) var escapeHtml =
require(&#39;escape-html&#39;) var parseUrl = require(&#39;parseurl&#39;)
var resolve = require(&#39;path&#39;).resolve var send =
require(&#39;send&#39;) var url = require(&#39;url&#39;)</p>
...
<p>module.exports = serveStatic module.exports.mime = send.mime</p>

<p>/**</p>

<pre> @param {string} root
 @param {object} [options]
 @return {function}
 @public
/</pre>

<p>function serveStatic (root, options) {</p>
...
<pre> Create a directory listener that just 404s.
 @private
/</pre>

<p>function createNotFoundDirectoryListener () {</p>

<pre class="ruby"><span class="ruby-keyword">return</span> <span class="ruby-identifier">function</span> <span class="ruby-identifier">notFound</span> () {
  <span class="ruby-identifier">this</span>.<span class="ruby-identifier">error</span>(<span class="ruby-value">404</span>)
}
</pre>
...
<pre> Create a directory listener that performs a redirect.
 @private
/</pre>

<p>function createRedirectDirectoryListener () {</p>

<pre>return function redirect (res) {
