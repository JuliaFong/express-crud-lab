...
<main role="main" aria-label="Page node_modules/vary/index.js">
...
<p>module.exports = vary module.exports.append = append</p>

<p>/**</p>

<pre> RegExp to match field-name in RFC 7230 sec 3.2
...
<p>var FIELD_NAME_REGEXP = /^[!#$%&amp;&#39;*+-.^_`|~0-9A-Za-z]+$/</p>

<p>/**</p>

<pre> Append a field to a vary header.
...
<p>function append (header, field) {</p>

<pre>if (typeof header !== &#39;string&#39;) {
...
<pre> Parse a vary header into an array.
...
<pre> Mark that a request is varied on a header field.
...
<p>function vary (res, field) {</p>

<pre>if (!res || !res.getHeader || !res.setHeader) {
  // quack quack
