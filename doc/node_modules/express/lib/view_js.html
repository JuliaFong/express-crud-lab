...
<title>view.js - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/express/lib/view.js">
...
<p>var debug = require(&#39;debug&#39;)(&#39;express:view&#39;); var path =
require(&#39;path&#39;); var fs = require(&#39;fs&#39;);</p>
...
<p>var dirname = path.dirname; var basename = path.basename; var extname =
path.extname; var join = path.join; var resolve = path.resolve;</p>
...
<pre> Initialize a new `View` with the given `name`.
...
<p>function View(name, options) {</p>
...
// lookup path
this.path = this.lookup(fileName);</pre>

<p>}</p>

<p>/**</p>

<pre> Lookup view by the given `name`

 @param {string} name
 @private
/</pre>

<p>View.prototype.lookup = function lookup(name) {</p>
...
<pre> Render with the given options.
...
<p>View.prototype.render = function render(options, callback) {</p>

<pre class="ruby"><span class="ruby-identifier">debug</span>(<span class="ruby-string">&#39;render &quot;%s&quot;&#39;</span>, <span class="ruby-identifier">this</span>.<span class="ruby-identifier">path</span>);
<span class="ruby-identifier">this</span>.<span class="ruby-identifier">engine</span>(<span class="ruby-identifier">this</span>.<span class="ruby-identifier">path</span>, <span class="ruby-identifier">options</span>, <span class="ruby-identifier">callback</span>);
</pre>
...
<pre> Resolve the file within the given directory.
...
<p>View.prototype.resolve = function resolve(dir, file) {</p>

<pre>var ext = this.ext;
...
<p>function tryStat(path) {</p>

<pre>debug(&#39;stat &quot;%s&quot;&#39;, path);
