...
<div class="nav-section">
  ...
  <ul class="link-list" role="directory">
    <li><a href="#label-type-is">type-is</a>
    <li><a href="#label-Install">Install</a>
    <li><a href="#label-API">API</a>
    <li><a href="#label-typeis-28request-2C+types-29">typeis(request, types)</a>
    <li><a href="#label-typeis.hasBody-28request-29">typeis.hasBody(request)</a>
    <li><a href="#label-typeis.is-28mediaType-2C+types-29">typeis.is(mediaType, types)</a>
    <li><a href="#label-Examples">Examples</a>
    <li><a href="#label-Example+body+parser">Example body parser</a>
...
<main role="main" aria-label="Page node_modules/type-is/README.md">

<h1 id="label-type-is">type-is<span><a href="#label-type-is">&para;</a> <a href="#top">&uarr;</a></span></h1>

<p><a href="https://npmjs.org/package/type-is"><img
src="https://badgen.net/npm/v/type-is"></a> <a
href="https://npmjs.org/package/type-is"><img
src="https://badgen.net/npm/dm/type-is"></a> <a
href="https://nodejs.org/en/download"><img
src="https://badgen.net/npm/node/type-is"></a> <a
href="https://travis-ci.org/jshttp/type-is"><img
src="https://badgen.net/travis/jshttp/type-is/master"></a> <a
href="https://coveralls.io/r/jshttp/type-is?branch=master"><img
src="https://badgen.net/coveralls/c/github/jshttp/type-is/master"></a></p>
...
<h3 id="label-typeis-28request-2C+types-29">typeis(request, types)<span><a href="#label-typeis-28request-2C+types-29">&para;</a> <a href="#top">&uarr;</a></span></h3>

<p>Checks if the <code>request</code> is one of the <code>types</code>. If the
request has no body, even if there is a <code>Content-Type</code> header,
then <code>null</code> is returned. If the <code>Content-Type</code> header
is invalid or does not matches any of the <code>types</code>, then
<code>false</code> is returned. Otherwise, a string of the type that
matched is returned.</p>

<p>The <code>request</code> argument is expected to be a Node.js HTTP request.
The <code>types</code> argument is an array of type strings.</p>

<p>Each type in the <code>types</code> array can be one of the following:</p>
<ul><li>
<p>A file extension name such as <code>json</code>. This name will be returned
if matched.</p>
</li><li>
<p>A mime type such as <code>application/json</code>.</p>
</li><li>
<p>A mime type with a wildcard such as <code>*</code> or <code>json</code> or
<code>application</code>.  The full mime type will be returned if matched.</p>
</li><li>
<p>A suffix such as <code>+json</code>. This can be combined with a wildcard
such as  <code>*/vnd+json</code> or <code>application/*+json</code>. The
full mime type will be returned  if matched.</p>
</li></ul>

<p>Some examples to illustrate the inputs and returned value:</p>
<!-- eslint-disable no-undef -->
<pre>// req.headers.content-type = &#39;application/json&#39;
...
typeis(req, [&#39;html&#39;]) // =&gt; false</pre>

<h3 id="label-typeis.hasBody-28request-29">typeis.hasBody(request)<span><a href="#label-typeis.hasBody-28request-29">&para;</a> <a href="#top">&uarr;</a></span></h3>
...
This is similar to how file existence works. If a body does exist, then
this indicates that there is data to read from the Node.js request stream.</p>
<!-- eslint-disable no-undef -->
<pre>if (typeis.hasBody(req)) {
...
<h3 id="label-typeis.is-28mediaType-2C+types-29">typeis.is(mediaType, types)<span><a href="#label-typeis.is-28mediaType-2C+types-29">&para;</a> <a href="#top">&uarr;</a></span></h3>

<p>Checks if the <code>mediaType</code> is one of the <code>types</code>. If
the <code>mediaType</code> is invalid or does not matches any of the
<code>types</code>, then <code>false</code> is returned. Otherwise, a
string of the type that matched is returned.</p>

<p>The <code>mediaType</code> argument is expected to be a <a
href="https://tools.ietf.org/html/rfc6838">media type</a> string. The
<code>types</code> argument is an array of type strings.</p>
...
<p>A mime type with a wildcard such as <strong><code>/</code></strong> or
<code>*/json</code> or <code>application/*</code>.  The full mime type will
be returned if matched.</p>
</li><li>
<p>A suffix such as <code>+json</code>. This can be combined with a wildcard
such as  <code>*/vnd+json</code> or <code>application/*+json</code>. The
full mime type will be returned  if matched.</p>
...
<p>Some examples to illustrate the inputs and returned value:</p>
<!-- eslint-disable no-undef -->
<pre>var mediaType = &#39;application/json&#39;
...
typeis.is(mediaType, [&#39;html&#39;]) // =&gt; false</pre>

<h2 id="label-Examples">Examples<span><a href="#label-Examples">&para;</a> <a href="#top">&uarr;</a></span></h2>

<h3 id="label-Example+body+parser">Example body parser<span><a href="#label-Example+body+parser">&para;</a> <a href="#top">&uarr;</a></span></h3>
