...
<main role="main" aria-label="Page node_modules/negotiator/lib/encoding.js">
...
<p>module.exports = preferredEncodings; module.exports.preferredEncodings =
preferredEncodings;</p>
...
<p>var simpleEncodingRegExp = /^<a href=“^s;”>s*(</a>+)s*(?:;(.*))?$/;</p>

<p>/**</p>

<pre> Parse the Accept-Encoding header.
 @private
/</pre>

<p>function parseAcceptEncoding(accept) {</p>
...
<pre> Parse an encoding from the Accept-Encoding header.
 @private
/</pre>

<p>function parseEncoding(str, i) {</p>

<pre>var match = simpleEncodingRegExp.exec(str);
...
<pre> Get the priority of an encoding.
 @private
/</pre>

<p>function getEncodingPriority(encoding, accepted, index) {</p>
...
<pre> Get the specificity of the encoding.
 @private
/</pre>

<p>function specify(encoding, spec, index) {</p>
...
<pre> Get the preferred encodings from an Accept-Encoding header.
 @public
/</pre>

<p>function preferredEncodings(accept, provided) {</p>

<pre>var accepts = parseAcceptEncoding(accept || &#39;&#39;);
...
<pre> Get full encoding string.
 @private
/</pre>

<p>function getFullEncoding(spec) {</p>

<pre class="ruby"><span class="ruby-keyword">return</span> <span class="ruby-identifier">spec</span>.<span class="ruby-identifier">encoding</span>;
</pre>
