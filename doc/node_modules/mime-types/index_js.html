...
<p>var db = require(&#39;mime-db&#39;) var extname =
require(&#39;path&#39;).extname</p>
...
<p>var EXTRACT_TYPE_REGEXP = /^<a href=“^;s”>s*(</a>*)(?:;|s|$)/ var
TEXT_TYPE_REGEXP = /^text//i</p>
...
<p>exports.charset = charset exports.charsets = { lookup: charset }
exports.contentType = contentType exports.extension = extension
exports.extensions = Object.create(null) exports.lookup = lookup
exports.types = Object.create(null)</p>

<p>// Populate the extensions/types maps populateMaps(exports.extensions,
exports.types)</p>
