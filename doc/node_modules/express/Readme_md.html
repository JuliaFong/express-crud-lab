...
<div class="nav-section">
  ...
  <ul class="link-list" role="directory">
    ...
    <li><a href="#label-Docs+-26+Community">Docs &amp; Community</a>
    <li><a href="#label-Security+Issues">Security Issues</a>
    ...
    <li><a href="#label-People">People</a>
...
<main role="main" aria-label="Page node_modules/express/Readme.md">

<p><a href="http://expressjs.com/"><img
src="https://i.cloudup.com/zfY6lL7eFa-3000x3000.png"></a></p>

<p>Fast, unopinionated, minimalist web framework for <a
href="http://nodejs.org">node</a>.</p>

<p><a href="https://npmjs.org/package/express"><img
src="https://img.shields.io/npm/v/express.svg"></a>  <a
href="https://npmjs.org/package/express"><img
src="https://img.shields.io/npm/dm/express.svg"></a>  <a
href="https://travis-ci.org/expressjs/express"><img
src="https://img.shields.io/travis/expressjs/express/master.svg?label=linux"></a>
<a href="https://ci.appveyor.com/project/dougwilson/express"><img
src="https://img.shields.io/appveyor/ci/dougwilson/express/master.svg?label=windows"></a>
<a href="https://coveralls.io/r/expressjs/express?branch=master"><img
src="https://img.shields.io/coveralls/expressjs/express/master.svg"></a></p>
...
through the <a href="https://www.npmjs.com/">npm registry</a>.</p>

<p>Before installing, <a href="https://nodejs.org/en/download/">download and
install Node.js</a>. Node.js 0.10 or higher is required.</p>

<p>Installation is done using the <a
href="https://docs.npmjs.com/getting-started/installing-npm-packages-locally">npm
install command</a>:</p>

<pre>$ npm install express</pre>

<p>Follow <a href="http://expressjs.com/en/starter/installing.html">our
installing guide</a> for more information.</p>

<h2 id="label-Features">Features<span><a href="#label-Features">&para;</a> <a href="#top">&uarr;</a></span></h2>
<ul><li>
<p>Robust routing</p>
</li><li>
<p>Focus on high performance</p>
</li><li>
<p>Super-high test coverage</p>
</li><li>
<p>HTTP helpers (redirection, caching, etc)</p>
</li><li>
<p>View system supporting 14+ template engines</p>
</li><li>
<p>Content negotiation</p>
</li><li>
<p>Executable for generating applications quickly</p>
</li></ul>

<h2 id="label-Docs+-26+Community">Docs &amp; Community<span><a href="#label-Docs+-26+Community">&para;</a> <a href="#top">&uarr;</a></span></h2>
<ul><li>
<p><a href="http://expressjs.com/">Website and Documentation</a> - [<a
href="https://github.com/expressjs/expressjs.com">website repo</a>]</p>
</li><li>
<p><a href="https://webchat.freenode.net/?channels=express">#express</a> on
freenode IRC</p>
</li><li>
<p><a href="https://github.com/expressjs">GitHub Organization</a> for Official
Middleware &amp; Modules</p>
</li><li>
<p>Visit the <a href="https://github.com/expressjs/express/wiki">Wiki</a></p>
</li><li>
<p><a href="https://groups.google.com/group/express-js">Google Group</a> for
discussion</p>
</li><li>
<p><a href="https://gitter.im/expressjs/express">Gitter</a> for support and
discussion</p>
</li></ul>

<p><strong>PROTIP</strong> Be sure to read <a
href="https://github.com/expressjs/express/wiki/Migrating-from-3.x-to-4.x">Migrating
from 3.x to 4.x</a> as well as <a
href="https://github.com/expressjs/express/wiki/New-features-in-4.x">New
features in 4.x</a>.</p>

<h3 id="label-Security+Issues">Security Issues<span><a href="#label-Security+Issues">&para;</a> <a href="#top">&uarr;</a></span></h3>

<p>If you discover a security vulnerability in Express, please see <a
href="Security.md">Security Policies and Procedures</a>.</p>

<h2 id="label-Quick+Start">Quick Start<span><a href="#label-Quick+Start">&para;</a> <a href="#top">&uarr;</a></span></h2>

<p>The quickest way to get started with express is to utilize the executable
<a href="https://github.com/expressjs/generator">express(1)</a> to generate
an application as shown below:</p>

<p>Install the executable. The executable&#39;s major version will match
Express&#39;s:</p>

<pre>$ npm install -g express-generator@4</pre>

<p>Create the app:</p>

<pre>$ express /tmp/foo &amp;&amp; cd /tmp/foo</pre>
...
<p>View the website at: <a href="http://localhost:3000">localhost:3000</a></p>

<h2 id="label-Philosophy">Philosophy<span><a href="#label-Philosophy">&para;</a> <a href="#top">&uarr;</a></span></h2>

<p>The Express philosophy is to provide small, robust tooling for HTTP
servers, making  it a great solution for single page applications, web
sites, hybrids, or public  HTTP APIs.</p>

<p>Express does not force you to use any specific ORM or template engine. With
support for over  14 template engines via <a
href="https://github.com/tj/consolidate.js">Consolidate.js</a>,  you can
quickly craft your perfect framework.</p>
...
<pre>$ node examples/content-negotiation</pre>

<h2 id="label-Tests">Tests<span><a href="#label-Tests">&para;</a> <a href="#top">&uarr;</a></span></h2>

<p>To run the test suite, first install the dependencies, then run <code>npm
test</code>:</p>
...
<h2 id="label-People">People<span><a href="#label-People">&para;</a> <a href="#top">&uarr;</a></span></h2>

<p>The original author of Express is <a href="https://github.com/tj">TJ
Holowaychuk</a></p>

<p>The current lead maintainer is <a
href="https://github.com/dougwilson">Douglas Christopher Wilson</a></p>

<p><a href="https://github.com/expressjs/express/graphs/contributors">List of
