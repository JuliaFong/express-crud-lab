...
<main role="main" aria-label="Page node_modules/ee-first/index.js">
...
<p>module.exports = first</p>

<p>/**</p>

<pre> Get the first event in a set of event emitters and event pairs.
...
<p>function first(stuff, done) {</p>

<pre>if (!Array.isArray(stuff))
...
<pre> Create the event listener.
 @private
/</pre>

<p>function listener(event, done) {</p>

<pre>return function onevent(arg1) {
