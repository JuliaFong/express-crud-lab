...
<div class="nav-section">
  ...
  <ul class="link-list" role="directory">
    <li><a href="#label-proxy-addr">proxy-addr</a>
    <li><a href="#label-Install">Install</a>
    <li><a href="#label-API">API</a>
    <li><a href="#label-proxyaddr-28req-2C+trust-29">proxyaddr(req, trust)</a>
    <li><a href="#label-proxyaddr.all-28req-2C+-5Btrust-5D-29">proxyaddr.all(req, [trust])</a>
    <li><a href="#label-proxyaddr.compile-28val-29">proxyaddr.compile(val)</a>
...
<main role="main" aria-label="Page node_modules/proxy-addr/README.md">

<h1 id="label-proxy-addr">proxy-addr<span><a href="#label-proxy-addr">&para;</a> <a href="#top">&uarr;</a></span></h1>

<p><a href="https://npmjs.org/package/proxy-addr"><img
src="https://badgen.net/npm/v/proxy-addr"></a> <a
href="https://npmjs.org/package/proxy-addr"><img
src="https://badgen.net/npm/dm/proxy-addr"></a> <a
href="https://nodejs.org/en/download"><img
src="https://badgen.net/npm/node/proxy-addr"></a> <a
href="https://travis-ci.org/jshttp/proxy-addr"><img
src="https://badgen.net/travis/jshttp/proxy-addr/master"></a> <a
href="https://coveralls.io/r/jshttp/proxy-addr?branch=master"><img
src="https://badgen.net/coveralls/c/github/jshttp/proxy-addr/master"></a></p>
...
<p>This is a <a href="https://nodejs.org/en/">Node.js</a> module available
through the <a href="https://www.npmjs.com/">npm registry</a>. Installation
is done using the <a
href="https://docs.npmjs.com/getting-started/installing-npm-packages-locally">npm
install command</a>:</p>

<pre>$ npm install proxy-addr</pre>

<h2 id="label-API">API<span><a href="#label-API">&para;</a> <a href="#top">&uarr;</a></span></h2>
<!-- eslint-disable no-unused-vars -->
<pre class="ruby"><span class="ruby-identifier">var</span> <span class="ruby-identifier">proxyaddr</span> = <span class="ruby-identifier">require</span>(<span class="ruby-string">&#39;proxy-addr&#39;</span>)
</pre>

<h3 id="label-proxyaddr-28req-2C+trust-29">proxyaddr(req, trust)<span><a href="#label-proxyaddr-28req-2C+trust-29">&para;</a> <a href="#top">&uarr;</a></span></h3>

<p>Return the address of the request, using the given <code>trust</code>
parameter.</p>

<p>The <code>trust</code> argument is a function that returns
<code>true</code> if you trust the address, <code>false</code> if you
don&#39;t. The closest untrusted address is returned.</p>
<!-- eslint-disable no-undef -->
<pre>proxyaddr(req, function (addr) { return addr === &#39;127.0.0.1&#39; })
proxyaddr(req, function (addr, i) { return i &lt; 1 })</pre>

<p>The <code>trust</code> arugment may also be a single IP address string or
an array of trusted addresses, as plain IP addresses, CIDR-formatted
strings, or IP/netmask strings.</p>
<!-- eslint-disable no-undef -->
<pre class="ruby"><span class="ruby-identifier">proxyaddr</span>(<span class="ruby-identifier">req</span>, <span class="ruby-string">&#39;127.0.0.1&#39;</span>)
<span class="ruby-identifier">proxyaddr</span>(<span class="ruby-identifier">req</span>, [<span class="ruby-string">&#39;127.0.0.0/8&#39;</span>, <span class="ruby-string">&#39;10.0.0.0/8&#39;</span>])
<span class="ruby-identifier">proxyaddr</span>(<span class="ruby-identifier">req</span>, [<span class="ruby-string">&#39;127.0.0.0/255.0.0.0&#39;</span>, <span class="ruby-string">&#39;192.168.0.0/255.255.0.0&#39;</span>])
</pre>

<p>This module also supports IPv6. Your IPv6 addresses will be normalized
automatically (i.e. <code>fe80::00ed:1</code> equals
<code>fe80:0:0:0:0:0:ed:1</code>).</p>
<!-- eslint-disable no-undef -->
<pre class="ruby"><span class="ruby-identifier">proxyaddr</span>(<span class="ruby-identifier">req</span>, <span class="ruby-string">&#39;::1&#39;</span>)
<span class="ruby-identifier">proxyaddr</span>(<span class="ruby-identifier">req</span>, [<span class="ruby-string">&#39;::1/128&#39;</span>, <span class="ruby-string">&#39;fe80::/10&#39;</span>])
</pre>

<p>This module will automatically work with IPv4-mapped IPv6 addresses as well
to support node.js in IPv6-only mode. This means that you do not have to
specify both <code>::ffff:a00:1</code> and <code>10.0.0.1</code>.</p>

<p>As a convenience, this module also takes certain pre-defined names in
addition to IP addresses, which expand into IP addresses:</p>
<!-- eslint-disable no-undef -->
<pre class="ruby"><span class="ruby-identifier">proxyaddr</span>(<span class="ruby-identifier">req</span>, <span class="ruby-string">&#39;loopback&#39;</span>)
<span class="ruby-identifier">proxyaddr</span>(<span class="ruby-identifier">req</span>, [<span class="ruby-string">&#39;loopback&#39;</span>, <span class="ruby-string">&#39;fc00:ac:1ab5:fff::1/64&#39;</span>])
</pre>
<ul><li>
<p><code>loopback</code>: IPv4 and IPv6 loopback addresses (like
<code>::1</code> and <code>127.0.0.1</code>).</p>
</li><li>
<p><code>linklocal</code>: IPv4 and IPv6 link-local addresses (like
<code>fe80::1:1:1:1</code> and <code>169.254.0.1</code>).</p>
</li><li>
<p><code>uniquelocal</code>: IPv4 private addresses and IPv6 unique-local
addresses (like <code>fc00:ac:1ab5:fff::1</code> and
<code>192.168.0.1</code>).</p>
</li></ul>

<p>When <code>trust</code> is specified as a function, it will be called for
each address to determine if it is a trusted address. The function is given
two arguments: <code>addr</code> and <code>i</code>, where
<code>addr</code> is a string of the address to check and <code>i</code> is
a number that represents the distance from the socket address.</p>

<h3 id="label-proxyaddr.all-28req-2C+-5Btrust-5D-29">proxyaddr.all(req, [trust])<span><a href="#label-proxyaddr.all-28req-2C+-5Btrust-5D-29">&para;</a> <a href="#top">&uarr;</a></span></h3>

<p>Return all the addresses of the request, optionally stopping at the first
untrusted. This array is ordered from closest to furthest (i.e.
<code>arr[0] === req.connection.remoteAddress</code>).</p>
<!-- eslint-disable no-undef -->
<pre class="ruby"><span class="ruby-identifier">proxyaddr</span>.<span class="ruby-identifier">all</span>(<span class="ruby-identifier">req</span>)
</pre>

<p>The optional <code>trust</code> argument takes the same arguments as
<code>trust</code> does in <code>proxyaddr(req, trust)</code>.</p>
<!-- eslint-disable no-undef -->
<pre class="ruby"><span class="ruby-identifier">proxyaddr</span>.<span class="ruby-identifier">all</span>(<span class="ruby-identifier">req</span>, <span class="ruby-string">&#39;loopback&#39;</span>)
</pre>

<h3 id="label-proxyaddr.compile-28val-29">proxyaddr.compile(val)<span><a href="#label-proxyaddr.compile-28val-29">&para;</a> <a href="#top">&uarr;</a></span></h3>

<p>Compiles argument <code>val</code> into a <code>trust</code> function. This
function takes the same arguments as <code>trust</code> does in
<code>proxyaddr(req, trust)</code> and returns a function suitable for
<code>proxyaddr(req, trust)</code>.</p>
<!-- eslint-disable no-undef, no-unused-vars -->
<pre class="ruby"><span class="ruby-identifier">var</span> <span class="ruby-identifier">trust</span> = <span class="ruby-identifier">proxyaddr</span>.<span class="ruby-identifier">compile</span>(<span class="ruby-string">&#39;loopback&#39;</span>)
<span class="ruby-identifier">var</span> <span class="ruby-identifier">addr</span> = <span class="ruby-identifier">proxyaddr</span>(<span class="ruby-identifier">req</span>, <span class="ruby-identifier">trust</span>)
</pre>

<p>This function is meant to be optimized for use against every request. It is
recommend to compile a trust function up-front for the trusted
configuration and pass that to <code>proxyaddr(req, trust)</code> for each
request.</p>
