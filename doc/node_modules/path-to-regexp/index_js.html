...
<main role="main" aria-label="Page node_modules/path-to-regexp/index.js">

<pre>Expose `pathtoRegexp`.</pre>

<p>module.exports = pathtoRegexp;</p>

<pre> Match matching groups in a regular expression.
/</pre>

<p>var MATCHING_GROUP_REGEXP = /((?!?)/g;</p>

<p>/**</p>

<pre> Normalize the given path string,
...
<p>function pathtoRegexp(path, keys, options) {</p>
...
return new RegExp(path, flags);</pre>
