...
<div class="nav-section">
  ...
  <ul class="link-list" role="directory">
    <li><a href="#label-accepts">accepts</a>
    <li><a href="#label-Installation">Installation</a>
    <li><a href="#label-API">API</a>
    <li><a href="#label-accepts-28req-29">accepts(req)</a>
    <li><a href="#label-.charset-28charsets-29">.charset(charsets)</a>
    <li><a href="#label-.charsets-28-29">.charsets()</a>
    <li><a href="#label-.encoding-28encodings-29">.encoding(encodings)</a>
    <li><a href="#label-.encodings-28-29">.encodings()</a>
    <li><a href="#label-.language-28languages-29">.language(languages)</a>
    <li><a href="#label-.languages-28-29">.languages()</a>
    <li><a href="#label-.type-28types-29">.type(types)</a>
    <li><a href="#label-.types-28-29">.types()</a>
    <li><a href="#label-Examples">Examples</a>
    <li><a href="#label-Simple+type+negotiation">Simple type negotiation</a>
...
<main role="main" aria-label="Page node_modules/accepts/README.md">

<h1 id="label-accepts">accepts<span><a href="#label-accepts">&para;</a> <a href="#top">&uarr;</a></span></h1>

<p><a href="https://npmjs.org/package/accepts"><img
src="https://badgen.net/npm/v/accepts"></a> <a
href="https://npmjs.org/package/accepts"><img
src="https://badgen.net/npm/dm/accepts"></a> <a
href="https://nodejs.org/en/download"><img
src="https://badgen.net/npm/node/accepts"></a> <a
href="https://travis-ci.org/jshttp/accepts"><img
src="https://badgen.net/travis/jshttp/accepts/master"></a> <a
href="https://coveralls.io/r/jshttp/accepts?branch=master"><img
src="https://badgen.net/coveralls/c/github/jshttp/accepts/master"></a></p>

<p>Higher level content negotiation based on <a
href="https://www.npmjs.com/package/negotiator">negotiator</a>. Extracted
from <a href="https://www.npmjs.com/package/koa">koa</a> for general use.</p>

<p>In addition to negotiator, it allows:</p>
<ul><li>
<p>Allows types as an array or arguments list, ie <code>([&#39;text/html&#39;,
&#39;application/json&#39;])</code>  as well as <code>(&#39;text/html&#39;,
&#39;application/json&#39;)</code>.</p>
</li><li>
<p>Allows type shorthands such as <code>json</code>.</p>
</li><li>
<p>Returns <code>false</code> when no types match</p>
</li><li>
<p>Treats non-existent headers as <code>*</code></p>
</li></ul>
...
<pre class="ruby"><span class="ruby-identifier">var</span> <span class="ruby-identifier">accepts</span> = <span class="ruby-identifier">require</span>(<span class="ruby-string">&#39;accepts&#39;</span>)
</pre>

<h3 id="label-accepts-28req-29">accepts(req)<span><a href="#label-accepts-28req-29">&para;</a> <a href="#top">&uarr;</a></span></h3>

<p>Create a new <code>Accepts</code> object for the given <code>req</code>.</p>

<h4 id="label-.charset-28charsets-29">.charset(charsets)<span><a href="#label-.charset-28charsets-29">&para;</a> <a href="#top">&uarr;</a></span></h4>

<p>Return the first accepted charset. If nothing in <code>charsets</code> is
accepted, then <code>false</code> is returned.</p>

<h4 id="label-.charsets-28-29">.charsets()<span><a href="#label-.charsets-28-29">&para;</a> <a href="#top">&uarr;</a></span></h4>

<p>Return the charsets that the request accepts, in the order of the
client&#39;s preference (most preferred first).</p>

<h4 id="label-.encoding-28encodings-29">.encoding(encodings)<span><a href="#label-.encoding-28encodings-29">&para;</a> <a href="#top">&uarr;</a></span></h4>

<p>Return the first accepted encoding. If nothing in <code>encodings</code> is
accepted, then <code>false</code> is returned.</p>

<h4 id="label-.encodings-28-29">.encodings()<span><a href="#label-.encodings-28-29">&para;</a> <a href="#top">&uarr;</a></span></h4>

<p>Return the encodings that the request accepts, in the order of the
client&#39;s preference (most preferred first).</p>

<h4 id="label-.language-28languages-29">.language(languages)<span><a href="#label-.language-28languages-29">&para;</a> <a href="#top">&uarr;</a></span></h4>

<p>Return the first accepted language. If nothing in <code>languages</code> is
accepted, then <code>false</code> is returned.</p>

<h4 id="label-.languages-28-29">.languages()<span><a href="#label-.languages-28-29">&para;</a> <a href="#top">&uarr;</a></span></h4>

<p>Return the languages that the request accepts, in the order of the
client&#39;s preference (most preferred first).</p>

<h4 id="label-.type-28types-29">.type(types)<span><a href="#label-.type-28types-29">&para;</a> <a href="#top">&uarr;</a></span></h4>

<p>Return the first accepted type (and it is returned as the same text as what
appears in the <code>types</code> array). If nothing in <code>types</code>
is accepted, then <code>false</code> is returned.</p>

<p>The <code>types</code> array can contain full MIME types or file
extensions. Any value that is not a full MIME types is passed to
<code>require(&#39;mime-types&#39;).lookup</code>.</p>

<h4 id="label-.types-28-29">.types()<span><a href="#label-.types-28-29">&para;</a> <a href="#top">&uarr;</a></span></h4>
...
<h3 id="label-Simple+type+negotiation">Simple type negotiation<span><a href="#label-Simple+type+negotiation">&para;</a> <a href="#top">&uarr;</a></span></h3>

<p>This simple example shows how to use <code>accepts</code> to return a
different typed respond body based on what the client wants to accept. The
server lists it&#39;s preferences in order and will get back the best match
between the client and server.</p>

<pre>var accepts = require(&#39;accepts&#39;)
...
<p>You can test this out with the cURL program: <code>sh curl -I
-H&#39;Accept: text/html&#39; http://localhost:3000/ </code></p>
