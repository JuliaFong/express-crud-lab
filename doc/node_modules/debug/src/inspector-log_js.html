...
<title>inspector-log.js - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/debug/src/inspector-log.js">

<p>module.exports = inspectorLog;</p>

<p>// black hole const nullStream = new
(require(&#39;stream&#39;).Writable)(); nullStream._write = () =&gt; {};</p>

<pre>Outputs a `console.log()` to the Node.js Inspector console *only*.</pre>

<p>function inspectorLog() {</p>

<pre class="ruby"><span class="ruby-identifier">const</span> <span class="ruby-identifier">stdout</span> = <span class="ruby-identifier">console</span>.<span class="ruby-identifier">_stdout</span>;
<span class="ruby-identifier">console</span>.<span class="ruby-identifier">_stdout</span> = <span class="ruby-identifier">nullStream</span>;
<span class="ruby-identifier">console</span>.<span class="ruby-identifier">log</span>.<span class="ruby-identifier">apply</span>(<span class="ruby-identifier">console</span>, <span class="ruby-identifier">arguments</span>);
<span class="ruby-identifier">console</span>.<span class="ruby-identifier">_stdout</span> = <span class="ruby-identifier">stdout</span>;
</pre>
