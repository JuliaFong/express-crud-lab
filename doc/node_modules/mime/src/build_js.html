...
<main role="main" aria-label="Page node_modules/mime/src/build.js">

<p>#!/usr/bin/env node</p>

<p>&#39;use strict&#39;;</p>

<p>const fs = require(&#39;fs&#39;); const path = require(&#39;path&#39;);
const mimeScore = require(&#39;mime-score&#39;);</p>

<p>let db = require(&#39;mime-db&#39;); let chalk = require(&#39;chalk&#39;);</p>

<p>const STANDARD_FACET_SCORE = 900;</p>

<p>const byExtension = {};</p>

<p>// Clear out any conflict extensions in mime-db for (let type in db) {</p>

<pre>let entry = db[type];
entry.type = type;
...
<p>function writeTypesFile(types, path) {</p>

<pre class="ruby"><span class="ruby-identifier">fs</span>.<span class="ruby-identifier">writeFileSync</span>(<span class="ruby-identifier">path</span>, <span class="ruby-constant">JSON</span>.<span class="ruby-identifier">stringify</span>(<span class="ruby-identifier">types</span>));
</pre>

<p>}</p>

<p>// Segregate into standard and non-standard types based on facet per // <a
href="https://tools.ietf.org/html/rfc6838#section-3.1">tools.ietf.org/html/rfc6838#section-3.1</a>
const types = {};</p>

<p>Object.keys(db).sort().forEach(k =&gt; {</p>

<pre class="ruby"><span class="ruby-identifier">const</span> <span class="ruby-identifier">entry</span> = <span class="ruby-identifier">db</span>[<span class="ruby-identifier">k</span>];
<span class="ruby-identifier">types</span>[<span class="ruby-identifier">entry</span>.<span class="ruby-identifier">type</span>] = <span class="ruby-identifier">entry</span>.<span class="ruby-identifier">extensions</span>;
</pre>

<p>});</p>

<p>writeTypesFile(types, path.join(__dirname, &#39;..&#39;,
&#39;types.json&#39;));</p>
</main>
