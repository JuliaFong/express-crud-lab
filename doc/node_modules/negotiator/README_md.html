...
<div class="nav-section">
  ...
  <ul class="link-list" role="directory">
    <li><a href="#label-negotiator">negotiator</a>
    <li><a href="#label-Installation">Installation</a>
    <li><a href="#label-API">API</a>
    <li><a href="#label-Accept+Negotiation">Accept Negotiation</a>
    <li><a href="#label-Methods">Methods</a>
    <li><a href="#label-mediaType-28-29">mediaType()</a>
    <li><a href="#label-mediaType-28availableMediaType-29">mediaType(availableMediaType)</a>
    <li><a href="#label-mediaTypes-28-29">mediaTypes()</a>
    <li><a href="#label-mediaTypes-28availableMediaTypes-29">mediaTypes(availableMediaTypes)</a>
    <li><a href="#label-Accept-Language+Negotiation">Accept-Language Negotiation</a>
    <li><a href="#label-Methods">Methods</a>
    <li><a href="#label-language-28-29">language()</a>
    <li><a href="#label-language-28availableLanguages-29">language(availableLanguages)</a>
    <li><a href="#label-languages-28-29">languages()</a>
    <li><a href="#label-languages-28availableLanguages-29">languages(availableLanguages)</a>
    <li><a href="#label-Accept-Charset+Negotiation">Accept-Charset Negotiation</a>
    <li><a href="#label-Methods">Methods</a>
    <li><a href="#label-charset-28-29">charset()</a>
    <li><a href="#label-charset-28availableCharsets-29">charset(availableCharsets)</a>
    <li><a href="#label-charsets-28-29">charsets()</a>
    <li><a href="#label-charsets-28availableCharsets-29">charsets(availableCharsets)</a>
    <li><a href="#label-Accept-Encoding+Negotiation">Accept-Encoding Negotiation</a>
    <li><a href="#label-Methods">Methods</a>
    <li><a href="#label-encoding-28-29">encoding()</a>
    <li><a href="#label-encoding-28availableEncodings-29">encoding(availableEncodings)</a>
    <li><a href="#label-encodings-28-29">encodings()</a>
    <li><a href="#label-encodings-28availableEncodings-29">encodings(availableEncodings)</a>
...
<main role="main" aria-label="Page node_modules/negotiator/README.md">

<h1 id="label-negotiator">negotiator<span><a href="#label-negotiator">&para;</a> <a href="#top">&uarr;</a></span></h1>

<p><a href="https://npmjs.org/package/negotiator"><img
src="https://img.shields.io/npm/v/negotiator.svg"></a> <a
href="https://npmjs.org/package/negotiator"><img
src="https://img.shields.io/npm/dm/negotiator.svg"></a> <a
href="https://nodejs.org/en/download/"><img
src="https://img.shields.io/node/v/negotiator.svg"></a> <a
href="https://travis-ci.org/jshttp/negotiator"><img
src="https://img.shields.io/travis/jshttp/negotiator/master.svg"></a> <a
href="https://coveralls.io/r/jshttp/negotiator?branch=master"><img
src="https://img.shields.io/coveralls/jshttp/negotiator/master.svg"></a></p>

<p>An HTTP content negotiator for Node.js</p>

<h2 id="label-Installation">Installation<span><a href="#label-Installation">&para;</a> <a href="#top">&uarr;</a></span></h2>

<pre>$ npm install negotiator</pre>

<h2 id="label-API">API<span><a href="#label-API">&para;</a> <a href="#top">&uarr;</a></span></h2>

<pre class="ruby"><span class="ruby-identifier">var</span> <span class="ruby-constant">Negotiator</span> = <span class="ruby-identifier">require</span>(<span class="ruby-string">&#39;negotiator&#39;</span>)
</pre>

<h3 id="label-Accept+Negotiation">Accept Negotiation<span><a href="#label-Accept+Negotiation">&para;</a> <a href="#top">&uarr;</a></span></h3>

<pre>availableMediaTypes = [&#39;text/html&#39;, &#39;text/plain&#39;, &#39;application/json&#39;]
...
<h4 id="label-Methods">Methods<span><a href="#label-Methods">&para;</a> <a href="#top">&uarr;</a></span></h4>

<h5 id="label-mediaType-28-29">mediaType()<span><a href="#label-mediaType-28-29">&para;</a> <a href="#top">&uarr;</a></span></h5>

<p>Returns the most preferred media type from the client.</p>

<h5 id="label-mediaType-28availableMediaType-29">mediaType(availableMediaType)<span><a href="#label-mediaType-28availableMediaType-29">&para;</a> <a href="#top">&uarr;</a></span></h5>

<p>Returns the most preferred media type from a list of available media types.</p>

<h5 id="label-mediaTypes-28-29">mediaTypes()<span><a href="#label-mediaTypes-28-29">&para;</a> <a href="#top">&uarr;</a></span></h5>

<p>Returns an array of preferred media types ordered by the client preference.</p>

<h5 id="label-mediaTypes-28availableMediaTypes-29">mediaTypes(availableMediaTypes)<span><a href="#label-mediaTypes-28availableMediaTypes-29">&para;</a> <a href="#top">&uarr;</a></span></h5>

<p>Returns an array of preferred media types ordered by priority from a list
of available media types.</p>

<h3 id="label-Accept-Language+Negotiation">Accept-Language Negotiation<span><a href="#label-Accept-Language+Negotiation">&para;</a> <a href="#top">&uarr;</a></span></h3>

<pre>negotiator = new Negotiator(request)
...
<h5 id="label-language-28-29">language()<span><a href="#label-language-28-29">&para;</a> <a href="#top">&uarr;</a></span></h5>

<p>Returns the most preferred language from the client.</p>

<h5 id="label-language-28availableLanguages-29">language(availableLanguages)<span><a href="#label-language-28availableLanguages-29">&para;</a> <a href="#top">&uarr;</a></span></h5>

<p>Returns the most preferred language from a list of available languages.</p>

<h5 id="label-languages-28-29">languages()<span><a href="#label-languages-28-29">&para;</a> <a href="#top">&uarr;</a></span></h5>

<p>Returns an array of preferred languages ordered by the client preference.</p>

<h5 id="label-languages-28availableLanguages-29">languages(availableLanguages)<span><a href="#label-languages-28availableLanguages-29">&para;</a> <a href="#top">&uarr;</a></span></h5>

<p>Returns an array of preferred languages ordered by priority from a list of
available languages.</p>

<h3 id="label-Accept-Charset+Negotiation">Accept-Charset Negotiation<span><a href="#label-Accept-Charset+Negotiation">&para;</a> <a href="#top">&uarr;</a></span></h3>

<pre>availableCharsets = [&#39;utf-8&#39;, &#39;iso-8859-1&#39;, &#39;iso-8859-5&#39;]
...
<h5 id="label-charset-28-29">charset()<span><a href="#label-charset-28-29">&para;</a> <a href="#top">&uarr;</a></span></h5>

<p>Returns the most preferred charset from the client.</p>

<h5 id="label-charset-28availableCharsets-29">charset(availableCharsets)<span><a href="#label-charset-28availableCharsets-29">&para;</a> <a href="#top">&uarr;</a></span></h5>

<p>Returns the most preferred charset from a list of available charsets.</p>

<h5 id="label-charsets-28-29">charsets()<span><a href="#label-charsets-28-29">&para;</a> <a href="#top">&uarr;</a></span></h5>

<p>Returns an array of preferred charsets ordered by the client preference.</p>

<h5 id="label-charsets-28availableCharsets-29">charsets(availableCharsets)<span><a href="#label-charsets-28availableCharsets-29">&para;</a> <a href="#top">&uarr;</a></span></h5>

<p>Returns an array of preferred charsets ordered by priority from a list of
available charsets.</p>

<h3 id="label-Accept-Encoding+Negotiation">Accept-Encoding Negotiation<span><a href="#label-Accept-Encoding+Negotiation">&para;</a> <a href="#top">&uarr;</a></span></h3>

<pre>availableEncodings = [&#39;identity&#39;, &#39;gzip&#39;]
...
<h5 id="label-encoding-28-29">encoding()<span><a href="#label-encoding-28-29">&para;</a> <a href="#top">&uarr;</a></span></h5>

<p>Returns the most preferred encoding from the client.</p>

<h5 id="label-encoding-28availableEncodings-29">encoding(availableEncodings)<span><a href="#label-encoding-28availableEncodings-29">&para;</a> <a href="#top">&uarr;</a></span></h5>

<p>Returns the most preferred encoding from a list of available encodings.</p>

<h5 id="label-encodings-28-29">encodings()<span><a href="#label-encodings-28-29">&para;</a> <a href="#top">&uarr;</a></span></h5>

<p>Returns an array of preferred encodings ordered by the client preference.</p>

<h5 id="label-encodings-28availableEncodings-29">encodings(availableEncodings)<span><a href="#label-encodings-28availableEncodings-29">&para;</a> <a href="#top">&uarr;</a></span></h5>
...
<p>The <a href="https://npmjs.org/package/accepts#readme">accepts</a> module
builds on this module and provides an alternative interface, mime type
