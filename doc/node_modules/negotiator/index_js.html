...
<main role="main" aria-label="Page node_modules/negotiator/index.js">
...
<pre> Cached loaded submodules.
 @private
/</pre>

<p>var modules = Object.create(null);</p>
...
<p>module.exports = Negotiator; module.exports.Negotiator = Negotiator;</p>

<p>/**</p>

<pre> Create a Negotiator instance from a request.
 @param {object} request
 @public
/</pre>

<p>function Negotiator(request) {</p>

<pre>if (!(this instanceof Negotiator)) {
  return new Negotiator(request);
}

this.request = request;</pre>

<p>}</p>

<p>Negotiator.prototype.charset = function charset(available) {</p>

<pre class="ruby"><span class="ruby-identifier">var</span> <span class="ruby-identifier">set</span> = <span class="ruby-identifier">this</span>.<span class="ruby-identifier">charsets</span>(<span class="ruby-identifier">available</span>);
<span class="ruby-keyword">return</span> <span class="ruby-identifier">set</span> <span class="ruby-operator">&amp;&amp;</span> <span class="ruby-identifier">set</span>[<span class="ruby-value">0</span>];
</pre>

<p>};</p>

<p>Negotiator.prototype.charsets = function charsets(available) {</p>

<pre class="ruby"><span class="ruby-identifier">var</span> <span class="ruby-identifier">preferredCharsets</span> = <span class="ruby-identifier">loadModule</span>(<span class="ruby-string">&#39;charset&#39;</span>).<span class="ruby-identifier">preferredCharsets</span>;
<span class="ruby-keyword">return</span> <span class="ruby-identifier">preferredCharsets</span>(<span class="ruby-identifier">this</span>.<span class="ruby-identifier">request</span>.<span class="ruby-identifier">headers</span>[<span class="ruby-string">&#39;accept-charset&#39;</span>], <span class="ruby-identifier">available</span>);
</pre>

<p>};</p>

<p>Negotiator.prototype.encoding = function encoding(available) {</p>

<pre class="ruby"><span class="ruby-identifier">var</span> <span class="ruby-identifier">set</span> = <span class="ruby-identifier">this</span>.<span class="ruby-identifier">encodings</span>(<span class="ruby-identifier">available</span>);
<span class="ruby-keyword">return</span> <span class="ruby-identifier">set</span> <span class="ruby-operator">&amp;&amp;</span> <span class="ruby-identifier">set</span>[<span class="ruby-value">0</span>];
</pre>

<p>};</p>

<p>Negotiator.prototype.encodings = function encodings(available) {</p>

<pre class="ruby"><span class="ruby-identifier">var</span> <span class="ruby-identifier">preferredEncodings</span> = <span class="ruby-identifier">loadModule</span>(<span class="ruby-string">&#39;encoding&#39;</span>).<span class="ruby-identifier">preferredEncodings</span>;
<span class="ruby-keyword">return</span> <span class="ruby-identifier">preferredEncodings</span>(<span class="ruby-identifier">this</span>.<span class="ruby-identifier">request</span>.<span class="ruby-identifier">headers</span>[<span class="ruby-string">&#39;accept-encoding&#39;</span>], <span class="ruby-identifier">available</span>);
</pre>

<p>};</p>

<p>Negotiator.prototype.language = function language(available) {</p>

<pre class="ruby"><span class="ruby-identifier">var</span> <span class="ruby-identifier">set</span> = <span class="ruby-identifier">this</span>.<span class="ruby-identifier">languages</span>(<span class="ruby-identifier">available</span>);
<span class="ruby-keyword">return</span> <span class="ruby-identifier">set</span> <span class="ruby-operator">&amp;&amp;</span> <span class="ruby-identifier">set</span>[<span class="ruby-value">0</span>];
</pre>

<p>};</p>

<p>Negotiator.prototype.languages = function languages(available) {</p>

<pre class="ruby"><span class="ruby-identifier">var</span> <span class="ruby-identifier">preferredLanguages</span> = <span class="ruby-identifier">loadModule</span>(<span class="ruby-string">&#39;language&#39;</span>).<span class="ruby-identifier">preferredLanguages</span>;
<span class="ruby-keyword">return</span> <span class="ruby-identifier">preferredLanguages</span>(<span class="ruby-identifier">this</span>.<span class="ruby-identifier">request</span>.<span class="ruby-identifier">headers</span>[<span class="ruby-string">&#39;accept-language&#39;</span>], <span class="ruby-identifier">available</span>);
</pre>

<p>};</p>

<p>Negotiator.prototype.mediaType = function mediaType(available) {</p>

<pre class="ruby"><span class="ruby-identifier">var</span> <span class="ruby-identifier">set</span> = <span class="ruby-identifier">this</span>.<span class="ruby-identifier">mediaTypes</span>(<span class="ruby-identifier">available</span>);
<span class="ruby-keyword">return</span> <span class="ruby-identifier">set</span> <span class="ruby-operator">&amp;&amp;</span> <span class="ruby-identifier">set</span>[<span class="ruby-value">0</span>];
</pre>

<p>};</p>

<p>Negotiator.prototype.mediaTypes = function mediaTypes(available) {</p>

<pre class="ruby"><span class="ruby-identifier">var</span> <span class="ruby-identifier">preferredMediaTypes</span> = <span class="ruby-identifier">loadModule</span>(<span class="ruby-string">&#39;mediaType&#39;</span>).<span class="ruby-identifier">preferredMediaTypes</span>;
<span class="ruby-keyword">return</span> <span class="ruby-identifier">preferredMediaTypes</span>(<span class="ruby-identifier">this</span>.<span class="ruby-identifier">request</span>.<span class="ruby-identifier">headers</span>.<span class="ruby-identifier">accept</span>, <span class="ruby-identifier">available</span>);
</pre>

<p>};</p>

<p>// Backwards compatibility Negotiator.prototype.preferredCharset =
Negotiator.prototype.charset; Negotiator.prototype.preferredCharsets =
Negotiator.prototype.charsets; Negotiator.prototype.preferredEncoding =
Negotiator.prototype.encoding; Negotiator.prototype.preferredEncodings =
Negotiator.prototype.encodings; Negotiator.prototype.preferredLanguage =
Negotiator.prototype.language; Negotiator.prototype.preferredLanguages =
Negotiator.prototype.languages; Negotiator.prototype.preferredMediaType =
Negotiator.prototype.mediaType; Negotiator.prototype.preferredMediaTypes =
Negotiator.prototype.mediaTypes;</p>

<p>/**</p>

<pre> Load the given module.
 @private
/</pre>

<p>function loadModule(moduleName) {</p>

<pre>var module = modules[moduleName];
