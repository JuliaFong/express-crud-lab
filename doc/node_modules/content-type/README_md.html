...
<div class="nav-section">
  ...
  <ul class="link-list" role="directory">
    <li><a href="#label-content-type">content-type</a>
    <li><a href="#label-Installation">Installation</a>
    <li><a href="#label-API">API</a>
    <li><a href="#label-contentType.parse-28string-29">contentType.parse(string)</a>
    <li><a href="#label-contentType.parse-28req-29">contentType.parse(req)</a>
    <li><a href="#label-contentType.parse-28res-29">contentType.parse(res)</a>
    <li><a href="#label-contentType.format-28obj-29">contentType.format(obj)</a>
...
<main role="main" aria-label="Page node_modules/content-type/README.md">

<h1 id="label-content-type">content-type<span><a href="#label-content-type">&para;</a> <a href="#top">&uarr;</a></span></h1>

<p><a href="https://npmjs.org/package/content-type"><img
src="https://img.shields.io/npm/v/content-type.svg"></a> <a
href="https://npmjs.org/package/content-type"><img
src="https://img.shields.io/npm/dm/content-type.svg"></a> <a
href="http://nodejs.org/download/"><img
src="https://img.shields.io/node/v/content-type.svg"></a> <a
href="https://travis-ci.org/jshttp/content-type"><img
src="https://img.shields.io/travis/jshttp/content-type/master.svg"></a> <a
href="https://coveralls.io/r/jshttp/content-type"><img
src="https://img.shields.io/coveralls/jshttp/content-type/master.svg"></a></p>

<p>Create and parse HTTP Content-Type header according to RFC 7231</p>

<h2 id="label-Installation">Installation<span><a href="#label-Installation">&para;</a> <a href="#top">&uarr;</a></span></h2>

<pre>$ npm install content-type</pre>

<h2 id="label-API">API<span><a href="#label-API">&para;</a> <a href="#top">&uarr;</a></span></h2>

<pre class="ruby"><span class="ruby-identifier">var</span> <span class="ruby-identifier">contentType</span> = <span class="ruby-identifier">require</span>(<span class="ruby-string">&#39;content-type&#39;</span>)
</pre>

<h3 id="label-contentType.parse-28string-29">contentType.parse(string)<span><a href="#label-contentType.parse-28string-29">&para;</a> <a href="#top">&uarr;</a></span></h3>

<pre class="ruby"><span class="ruby-identifier">var</span> <span class="ruby-identifier">obj</span> = <span class="ruby-identifier">contentType</span>.<span class="ruby-identifier">parse</span>(<span class="ruby-string">&#39;image/svg+xml; charset=utf-8&#39;</span>)
</pre>

<p>Parse a content type string. This will return an object with the following
properties (examples are shown for the string <code>&#39;image/svg+xml;
charset=utf-8&#39;</code>):</p>
<ul><li>
<p><code>type</code>: The media type (the type and subtype, always lower
case).  Example: <code>&#39;image/svg+xml&#39;</code></p>
</li><li>
<p><code>parameters</code>: An object of the parameters in the media type
(name of parameter  always lower case). Example: <code>{charset:
&#39;utf-8&#39;}</code></p>
</li></ul>

<p>Throws a <code>TypeError</code> if the string is missing or invalid.</p>

<h3 id="label-contentType.parse-28req-29">contentType.parse(req)<span><a href="#label-contentType.parse-28req-29">&para;</a> <a href="#top">&uarr;</a></span></h3>

<pre class="ruby"><span class="ruby-identifier">var</span> <span class="ruby-identifier">obj</span> = <span class="ruby-identifier">contentType</span>.<span class="ruby-identifier">parse</span>(<span class="ruby-identifier">req</span>)
</pre>

<p>Parse the <code>content-type</code> header from the given <code>req</code>.
Short-cut for <code>contentType.parse(req.headers['content-type'])</code>.</p>

<p>Throws a <code>TypeError</code> if the <code>Content-Type</code> header is
missing or invalid.</p>

<h3 id="label-contentType.parse-28res-29">contentType.parse(res)<span><a href="#label-contentType.parse-28res-29">&para;</a> <a href="#top">&uarr;</a></span></h3>

<pre class="ruby"><span class="ruby-identifier">var</span> <span class="ruby-identifier">obj</span> = <span class="ruby-identifier">contentType</span>.<span class="ruby-identifier">parse</span>(<span class="ruby-identifier">res</span>)
</pre>

<p>Parse the <code>content-type</code> header set on the given
<code>res</code>. Short-cut for
<code>contentType.parse(res.getHeader(&#39;content-type&#39;))</code>.</p>

<p>Throws a <code>TypeError</code> if the <code>Content-Type</code> header is
missing or invalid.</p>

<h3 id="label-contentType.format-28obj-29">contentType.format(obj)<span><a href="#label-contentType.format-28obj-29">&para;</a> <a href="#top">&uarr;</a></span></h3>

<pre class="ruby"><span class="ruby-identifier">var</span> <span class="ruby-identifier">str</span> = <span class="ruby-identifier">contentType</span>.<span class="ruby-identifier">format</span>({<span class="ruby-identifier">type</span><span class="ruby-operator">:</span> <span class="ruby-string">&#39;image/svg+xml&#39;</span>})
</pre>

<p>Format an object into a content type string. This will return a string of
the content type for the given object with the following properties
(examples are shown that produce the string <code>&#39;image/svg+xml;
charset=utf-8&#39;</code>):</p>
<ul><li>
<p><code>type</code>: The media type (will be lower-cased). Example:
<code>&#39;image/svg+xml&#39;</code></p>
</li><li>
<p><code>parameters</code>: An object of the parameters in the media type
(name of the  parameter will be lower-cased). Example: <code>{charset:
&#39;utf-8&#39;}</code></p>
</li></ul>

<p>Throws a <code>TypeError</code> if the object contains an invalid type or
parameter names.</p>
