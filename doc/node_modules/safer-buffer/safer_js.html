...
<title>safer.js - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/safer-buffer/safer.js">

<pre>eslint-disable node/no-deprecated-api</pre>

<p>&#39;use strict&#39;</p>

<p>var buffer = require(&#39;buffer&#39;) var Buffer = buffer.Buffer</p>

<p>var safer = {}</p>

<p>var key</p>

<p>for (key in buffer) {</p>

<pre>if (!buffer.hasOwnProperty(key)) continue
if (key === &#39;SlowBuffer&#39; || key === &#39;Buffer&#39;) continue
safer[key] = buffer[key]</pre>

<p>}</p>

<p>var Safer = safer.Buffer = {} for (key in Buffer) {</p>
...
<p>safer.Buffer.prototype = Buffer.prototype</p>

<p>if (!Safer.from || Safer.from === Uint8Array.from) {</p>

<pre>Safer.from = function (value, encodingOrOffset, length) {
...
<pre>Safer.alloc = function (size, fill, encoding) {
