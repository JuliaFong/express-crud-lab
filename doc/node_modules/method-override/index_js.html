...
<main role="main" aria-label="Page node_modules/method-override/index.js">
...
<p>var debug = require(&#39;debug&#39;)(&#39;method-override&#39;) var methods
= require(&#39;methods&#39;) var parseurl = require(&#39;parseurl&#39;) var
querystring = require(&#39;querystring&#39;) var vary =
require(&#39;vary&#39;)</p>
...
<p>module.exports = function methodOverride (getter, options) {</p>
...
<pre> Create a getter for the given string.
/</pre>

<p>function createGetter (str) {</p>

<pre>if (str.substr(0, 2).toUpperCase() === &#39;X-&#39;) {
  // header getter
  return createHeaderGetter(str)
}

return createQueryGetter(str)</pre>

<p>}</p>

<p>/**</p>

<pre> Create a getter for the given query key name.
/</pre>

<p>function createQueryGetter (key) {</p>

<pre>return function (req, res) {
...
<pre> Create a getter for the given header name.
/</pre>

<p>function createHeaderGetter (str) {</p>

<pre>var name = str.toLowerCase()
...
<pre class="ruby"> <span class="ruby-constant">Check</span> <span class="ruby-keyword">if</span> <span class="ruby-identifier">node</span> <span class="ruby-identifier">supports</span> <span class="ruby-value">%x`method`</span>.
<span class="ruby-operator">/</span>
</pre>

<p>function supports (method) {</p>

<pre>return method &amp;&amp;
  typeof method === &#39;string&#39; &amp;&amp;
  methods.indexOf(method.toLowerCase()) !== -1</pre>
