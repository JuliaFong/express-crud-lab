...
<div class="nav-section">
  ...
  <ul class="link-list" role="directory">
    <li><a href="#label-EE+First">EE First</a>
    <li><a href="#label-Install">Install</a>
    <li><a href="#label-API">API</a>
    <li><a href="#label-first-28arr-2C+listener-29">first(arr, listener)</a>
    <li><a href="#label-.cancel-28-29">.cancel()</a>
  </ul>
</div>
...
<main role="main" aria-label="Page node_modules/ee-first/README.md">

<h1 id="label-EE+First">EE First<span><a href="#label-EE+First">&para;</a> <a href="#top">&uarr;</a></span></h1>

<p><a href="https://npmjs.org/package/ee-first"><img
src="https://img.shields.io/npm/v/ee-first.svg?style=flat-square"></a> <a
href="https://travis-ci.org/jonathanong/ee-first"><img
src="https://img.shields.io/travis/jonathanong/ee-first.svg?style=flat-square"></a>
<a href="https://coveralls.io/r/jonathanong/ee-first?branch=master"><img
src="https://img.shields.io/coveralls/jonathanong/ee-first.svg?style=flat-square"></a>
<a href="LICENSE.md"><img
src="http://img.shields.io/npm/l/ee-first.svg?style=flat-square"></a> <a
href="https://npmjs.org/package/ee-first"><img
src="http://img.shields.io/npm/dm/ee-first.svg?style=flat-square"></a> <a
href="https://www.gittip.com/jonathanong/"><img
src="https://img.shields.io/gittip/jonathanong.svg?style=flat-square"></a></p>

<p>Get the first event in a set of event emitters and event pairs, then clean
up after itself.</p>

<h2 id="label-Install">Install<span><a href="#label-Install">&para;</a> <a href="#top">&uarr;</a></span></h2>

<pre>$ npm install ee-first</pre>

<h2 id="label-API">API<span><a href="#label-API">&para;</a> <a href="#top">&uarr;</a></span></h2>

<pre class="ruby"><span class="ruby-identifier">var</span> <span class="ruby-identifier">first</span> = <span class="ruby-identifier">require</span>(<span class="ruby-string">&#39;ee-first&#39;</span>)
</pre>

<h3 id="label-first-28arr-2C+listener-29">first(arr, listener)<span><a href="#label-first-28arr-2C+listener-29">&para;</a> <a href="#top">&uarr;</a></span></h3>

<p>Invoke <code>listener</code> on the first event from the list specified in
<code>arr</code>. <code>arr</code> is an array of arrays, with each array
in the format <code>[ee, ...event]</code>. <code>listener</code> will be
called only once, the first time any of the given events are emitted. If
<code>error</code> is one of the listened events, then if that fires first,
the <code>listener</code> will be given the <code>err</code> argument.</p>

<p>The <code>listener</code> is invoked as <code>listener(err, ee, event,
args)</code>, where <code>err</code> is the first argument emitted from an
<code>error</code> event, if applicable; <code>ee</code> is the event
emitter that fired; <code>event</code> is the string event name that fired;
and <code>args</code> is an array of the arguments that were emitted on the
event.</p>

<pre>var ee1 = new EventEmitter()
...
<h4 id="label-.cancel-28-29">.cancel()<span><a href="#label-.cancel-28-29">&para;</a> <a href="#top">&uarr;</a></span></h4>

<p>The group of listeners can be cancelled before being invoked and have all
the event listeners removed from the underlying event emitters.</p>
