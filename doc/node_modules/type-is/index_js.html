...
<main role="main" aria-label="Page node_modules/type-is/index.js">
...
<p>var typer = require(&#39;media-typer&#39;) var mime =
...
<p>module.exports = typeofrequest module.exports.is = typeis
module.exports.hasBody = hasbody module.exports.normalize = normalize
module.exports.match = mimeMatch</p>

<p>/**</p>

<pre> Compare a `value` content-type with `types`.
...
<p>function typeis (value, types_) {</p>
...
<pre> Check if a request has a request body.
...
<p>function hasbody (req) {</p>

<pre>return req.headers[&#39;transfer-encoding&#39;] !== undefined ||
  !isNaN(req.headers[&#39;content-length&#39;])</pre>

<p>}</p>

<p>/**</p>

<pre> Check if the incoming request contains the &quot;Content-Type&quot;
...
<p>function typeofrequest (req, types_) {</p>
...
return typeis(value, types)</pre>

<p>}</p>

<p>/**</p>

<pre> Normalize a mime type.
...
<p>function normalize (type) {</p>

<pre>if (typeof type !== &#39;string&#39;) {
  // invalid type
  return false
}
...
<pre> Check if `expected` mime type
...
<p>function mimeMatch (expected, actual) {</p>
...
<pre> Normalize a type and remove parameters.
...
<p>function normalizeType (value) {</p>
...
// reformat it
return typer.format(type)</pre>

<p>}</p>

<p>/**</p>

<pre> Try to normalize a type and remove parameters.
...
<p>function tryNormalizeType (value) {</p>
