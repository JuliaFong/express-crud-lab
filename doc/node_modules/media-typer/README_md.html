...
<div class="nav-section">
  ...
  <ul class="link-list" role="directory">
    <li><a href="#label-media-typer">media-typer</a>
    <li><a href="#label-Installation">Installation</a>
    <li><a href="#label-API">API</a>
    <li><a href="#label-typer.parse-28string-29">typer.parse(string)</a>
    <li><a href="#label-typer.parse-28req-29">typer.parse(req)</a>
    <li><a href="#label-typer.parse-28res-29">typer.parse(res)</a>
    <li><a href="#label-typer.format-28obj-29">typer.format(obj)</a>
...
<main role="main" aria-label="Page node_modules/media-typer/README.md">

<h1 id="label-media-typer">media-typer<span><a href="#label-media-typer">&para;</a> <a href="#top">&uarr;</a></span></h1>

<p><a href="https://npmjs.org/package/media-typer"><img
src="https://img.shields.io/npm/v/media-typer.svg?style=flat"></a> <a
href="https://npmjs.org/package/media-typer"><img
src="https://img.shields.io/npm/dm/media-typer.svg?style=flat"></a> <a
href="http://nodejs.org/download/"><img
src="https://img.shields.io/badge/node.js-%3E%3D_0.6-brightgreen.svg?style=flat"></a>
<a href="https://travis-ci.org/jshttp/media-typer"><img
src="https://img.shields.io/travis/jshttp/media-typer.svg?style=flat"></a>
<a href="https://coveralls.io/r/jshttp/media-typer"><img
src="https://img.shields.io/coveralls/jshttp/media-typer.svg?style=flat"></a></p>

<p>Simple RFC 6838 media type parser</p>

<h2 id="label-Installation">Installation<span><a href="#label-Installation">&para;</a> <a href="#top">&uarr;</a></span></h2>

<pre>$ npm install media-typer</pre>

<h2 id="label-API">API<span><a href="#label-API">&para;</a> <a href="#top">&uarr;</a></span></h2>

<pre class="ruby"><span class="ruby-identifier">var</span> <span class="ruby-identifier">typer</span> = <span class="ruby-identifier">require</span>(<span class="ruby-string">&#39;media-typer&#39;</span>)
</pre>

<h3 id="label-typer.parse-28string-29">typer.parse(string)<span><a href="#label-typer.parse-28string-29">&para;</a> <a href="#top">&uarr;</a></span></h3>

<pre class="ruby"><span class="ruby-identifier">var</span> <span class="ruby-identifier">obj</span> = <span class="ruby-identifier">typer</span>.<span class="ruby-identifier">parse</span>(<span class="ruby-string">&#39;image/svg+xml; charset=utf-8&#39;</span>)
</pre>
...
<ul><li>
<p><code>type</code>: The type of the media type (always lower case). Example:
<code>&#39;image&#39;</code></p>
</li><li>
<p><code>subtype</code>: The subtype of the media type (always lower case).
Example: <code>&#39;svg&#39;</code></p>
</li><li>
<p><code>suffix</code>: The suffix of the media type (always lower case).
Example: <code>&#39;xml&#39;</code></p>
</li><li>
...
<h3 id="label-typer.parse-28req-29">typer.parse(req)<span><a href="#label-typer.parse-28req-29">&para;</a> <a href="#top">&uarr;</a></span></h3>

<pre class="ruby"><span class="ruby-identifier">var</span> <span class="ruby-identifier">obj</span> = <span class="ruby-identifier">typer</span>.<span class="ruby-identifier">parse</span>(<span class="ruby-identifier">req</span>)
</pre>

<p>Parse the <code>content-type</code> header from the given <code>req</code>.
Short-cut for <code>typer.parse(req.headers['content-type'])</code>.</p>

<h3 id="label-typer.parse-28res-29">typer.parse(res)<span><a href="#label-typer.parse-28res-29">&para;</a> <a href="#top">&uarr;</a></span></h3>

<pre class="ruby"><span class="ruby-identifier">var</span> <span class="ruby-identifier">obj</span> = <span class="ruby-identifier">typer</span>.<span class="ruby-identifier">parse</span>(<span class="ruby-identifier">res</span>)
</pre>
...
<h3 id="label-typer.format-28obj-29">typer.format(obj)<span><a href="#label-typer.format-28obj-29">&para;</a> <a href="#top">&uarr;</a></span></h3>

<pre class="ruby"><span class="ruby-identifier">var</span> <span class="ruby-identifier">obj</span> = <span class="ruby-identifier">typer</span>.<span class="ruby-identifier">format</span>({<span class="ruby-identifier">type</span><span class="ruby-operator">:</span> <span class="ruby-string">&#39;image&#39;</span>, <span class="ruby-identifier">subtype</span><span class="ruby-operator">:</span> <span class="ruby-string">&#39;svg&#39;</span>, <span class="ruby-identifier">suffix</span><span class="ruby-operator">:</span> <span class="ruby-string">&#39;xml&#39;</span>})
</pre>
