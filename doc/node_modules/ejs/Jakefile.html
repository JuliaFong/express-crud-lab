...
<title>Jakefile - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/ejs/Jakefile">

<p>var fs = require(&#39;fs&#39;); var execSync =
require(&#39;child_process&#39;).execSync; var exec = function (cmd) {</p>

<pre class="ruby"><span class="ruby-identifier">execSync</span>(<span class="ruby-identifier">cmd</span>, {<span class="ruby-identifier">stdio</span><span class="ruby-operator">:</span> <span class="ruby-string">&#39;inherit&#39;</span>});
</pre>

<p>};</p>

<pre class="ruby"><span class="ruby-identifier">global</span> <span class="ruby-identifier">jake</span>, <span class="ruby-identifier">task</span>, <span class="ruby-identifier">desc</span>, <span class="ruby-identifier">publishTask</span>
</pre>

<p>task(&#39;build&#39;, [&#39;lint&#39;, &#39;clean&#39;,
&#39;browserify&#39;, &#39;minify&#39;], function () {</p>

<pre class="ruby"><span class="ruby-identifier">console</span>.<span class="ruby-identifier">log</span>(<span class="ruby-string">&#39;Build completed.&#39;</span>);
</pre>

<p>});</p>

<p>desc(&#39;Cleans browerified/minified files and package files&#39;);
task(&#39;clean&#39;, [&#39;clobber&#39;], function () {</p>

<pre class="ruby"><span class="ruby-identifier">jake</span>.<span class="ruby-identifier">rmRf</span>(<span class="ruby-string">&#39;./ejs.js&#39;</span>);
<span class="ruby-identifier">jake</span>.<span class="ruby-identifier">rmRf</span>(<span class="ruby-string">&#39;./ejs.min.js&#39;</span>);
<span class="ruby-identifier">console</span>.<span class="ruby-identifier">log</span>(<span class="ruby-string">&#39;Cleaned up compiled files.&#39;</span>);
</pre>

<p>});</p>

<p>desc(&#39;Lints the source code&#39;); task(&#39;lint&#39;, function () {</p>

<pre class="ruby"><span class="ruby-identifier">exec</span>(<span class="ruby-string">&#39;./node_modules/.bin/eslint &quot;**/*.js&quot; Jakefile&#39;</span>);
<span class="ruby-identifier">console</span>.<span class="ruby-identifier">log</span>(<span class="ruby-string">&#39;Linting completed.&#39;</span>);
</pre>

<p>});</p>

<p>task(&#39;browserify&#39;, function () {</p>

<pre class="ruby"><span class="ruby-identifier">exec</span>(<span class="ruby-string">&#39;./node_modules/browserify/bin/cmd.js --standalone ejs lib/ejs.js &gt; ejs.js&#39;</span>);
<span class="ruby-identifier">console</span>.<span class="ruby-identifier">log</span>(<span class="ruby-string">&#39;Browserification completed.&#39;</span>);
</pre>

<p>});</p>

<p>task(&#39;minify&#39;, function () {</p>

<pre class="ruby"><span class="ruby-identifier">exec</span>(<span class="ruby-string">&#39;./node_modules/uglify-js/bin/uglifyjs ejs.js &gt; ejs.min.js&#39;</span>);
<span class="ruby-identifier">console</span>.<span class="ruby-identifier">log</span>(<span class="ruby-string">&#39;Minification completed.&#39;</span>);
</pre>

<p>});</p>

<p>task(&#39;doc&#39;, function (dev) {</p>

<pre class="ruby"><span class="ruby-identifier">jake</span>.<span class="ruby-identifier">rmRf</span>(<span class="ruby-string">&#39;out&#39;</span>);
<span class="ruby-identifier">var</span> <span class="ruby-identifier">p</span> = <span class="ruby-identifier">dev</span> <span class="ruby-operator">?</span> <span class="ruby-string">&#39;-p&#39;</span> <span class="ruby-operator">:</span> <span class="ruby-string">&#39;&#39;</span>;
<span class="ruby-identifier">exec</span>(<span class="ruby-string">&#39;./node_modules/.bin/jsdoc &#39;</span> <span class="ruby-operator">+</span> <span class="ruby-identifier">p</span> <span class="ruby-operator">+</span> <span class="ruby-string">&#39; -c jsdoc.json lib/* docs/jsdoc/*&#39;</span>);
<span class="ruby-identifier">console</span>.<span class="ruby-identifier">log</span>(<span class="ruby-string">&#39;Documentation generated.&#39;</span>);
</pre>

<p>});</p>

<p>task(&#39;docPublish&#39;, [&#39;doc&#39;], function () {</p>

<pre class="ruby"><span class="ruby-identifier">fs</span>.<span class="ruby-identifier">writeFileSync</span>(<span class="ruby-string">&#39;out/CNAME&#39;</span>, <span class="ruby-string">&#39;api.ejs.co&#39;</span>);
<span class="ruby-identifier">console</span>.<span class="ruby-identifier">log</span>(<span class="ruby-string">&#39;Pushing docs to gh-pages...&#39;</span>);
<span class="ruby-identifier">exec</span>(<span class="ruby-string">&#39;./node_modules/.bin/git-directory-deploy --directory out/&#39;</span>);
<span class="ruby-identifier">console</span>.<span class="ruby-identifier">log</span>(<span class="ruby-string">&#39;Docs published to gh-pages.&#39;</span>);
</pre>

<p>});</p>

<p>task(&#39;test&#39;, [&#39;lint&#39;], function () {</p>

<pre class="ruby"><span class="ruby-identifier">exec</span>(<span class="ruby-string">&#39;./node_modules/.bin/mocha&#39;</span>);
</pre>

<p>});</p>

<p>publishTask(&#39;ejs&#39;, [&#39;build&#39;], function () {</p>

<pre class="ruby"><span class="ruby-identifier">this</span>.<span class="ruby-identifier">packageFiles</span>.<span class="ruby-identifier">include</span>([
  <span class="ruby-string">&#39;Jakefile&#39;</span>,
  <span class="ruby-string">&#39;README.md&#39;</span>,
  <span class="ruby-string">&#39;LICENSE&#39;</span>,
  <span class="ruby-string">&#39;package.json&#39;</span>,
  <span class="ruby-string">&#39;ejs.js&#39;</span>,
  <span class="ruby-string">&#39;ejs.min.js&#39;</span>,
...
<p>jake.Task.publish.on(&#39;complete&#39;, function () {</p>

<pre class="ruby"><span class="ruby-identifier">console</span>.<span class="ruby-identifier">log</span>(<span class="ruby-string">&#39;Updating hosted docs...&#39;</span>);
<span class="ruby-identifier">console</span>.<span class="ruby-identifier">log</span>(<span class="ruby-string">&#39;If this fails, run jake docPublish to re-try.&#39;</span>);
<span class="ruby-identifier">jake</span>.<span class="ruby-constant">Task</span>.<span class="ruby-identifier">docPublish</span>.<span class="ruby-identifier">invoke</span>();
</pre>
