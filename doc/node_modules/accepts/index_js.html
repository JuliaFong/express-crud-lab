...
<main role="main" aria-label="Page node_modules/accepts/index.js">
...
<p>var Negotiator = require(&#39;negotiator&#39;) var mime =
require(&#39;mime-types&#39;)</p>
...
<p>module.exports = Accepts</p>

<p>/**</p>

<pre> Create a new Accepts object for the given req.

 @param {object} req
 @public
/</pre>

<p>function Accepts (req) {</p>

<pre>if (!(this instanceof Accepts)) {
  return new Accepts(req)
}

this.headers = req.headers
this.negotiator = new Negotiator(req)</pre>

<p>}</p>

<p>/**</p>

<pre> Check if the given `type(s)` is acceptable, returning
...
<p>Accepts.prototype.type = Accepts.prototype.types = function (types_) {</p>

<pre>var types = types_
...
<pre> Return accepted encodings or best fit based on `encodings`.
...
<p>Accepts.prototype.encoding = Accepts.prototype.encodings = function
(encodings_) {</p>

<pre>var encodings = encodings_
...
return this.negotiator.encodings(encodings)[0] || false</pre>

<p>}</p>

<p>/**</p>

<pre> Return accepted charsets or best fit based on `charsets`.
...
<p>Accepts.prototype.charset = Accepts.prototype.charsets = function
(charsets_) {</p>

<pre>var charsets = charsets_
...
return this.negotiator.charsets(charsets)[0] || false</pre>

<p>}</p>

<p>/**</p>

<pre> Return accepted languages or best fit based on `langs`.
...
<p>Accepts.prototype.lang = Accepts.prototype.langs =
Accepts.prototype.language = Accepts.prototype.languages = function
(languages_) {</p>

<pre>var languages = languages_
...
return this.negotiator.languages(languages)[0] || false</pre>

<p>}</p>

<p>/**</p>

<pre> Convert extnames to mime.
...
<p>function extToMime (type) {</p>

<pre>return type.indexOf(&#39;/&#39;) === -1
  ? mime.lookup(type)
  : type</pre>
...
<p>function validMime (type) {</p>

<pre class="ruby"><span class="ruby-keyword">return</span> <span class="ruby-identifier">typeof</span> <span class="ruby-identifier">type</span> <span class="ruby-operator">===</span> <span class="ruby-string">&#39;string&#39;</span>
</pre>
