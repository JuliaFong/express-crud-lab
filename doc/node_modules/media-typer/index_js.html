...
<main role="main" aria-label="Page node_modules/media-typer/index.js">
...
<p>var paramRegExp = /; *([!#$%&amp;&#39;*+-.0-9A-Z^_`a-z|~]+) *= *(“(?:[ !<a
href=”u0020-u007e“>u0023-u005bu005d-u007eu0080-u00ff]|\</a>)*”|[!#$%&amp;&#39;*+-.0-9A-Z^_`a-z|~]+)
g; var textRegExp = /^[u0020-u007eu0080-u00ff]+$/ var tokenRegExp =
/^[!#$%&amp;&#39;*+-.0-9A-Z^_`a-z|~]+$/</p>

<p>/**</p>

<pre> RegExp to match quoted-pair in RFC 2616

 quoted-pair = &quot;\&quot; CHAR
 CHAR        = &lt;any US-ASCII character (octets 0 - 127)&gt;
/</pre>

<p>var qescRegExp = /\([u0000-u007f])/g;</p>

<p>/**</p>

<pre> RegExp to match chars that must be quoted-pair in RFC 2616
/</pre>

<p>var quoteRegExp = /([\“])/g;</p>

<p>/**</p>

<pre> RegExp to match type in RFC 6838
...
<p>var subtypeNameRegExp = /^[<a
href="A-Za-z0-9!#$&^_.-">A-Za-z0-9]</a>{0,126}$/ var typeNameRegExp = /^[<a
href="A-Za-z0-9!#$&^_-">A-Za-z0-9]</a>{0,126}$/ var typeRegExp = /^ *([<a
href="A-Za-z0-9!#$&^_-">A-Za-z0-9]</a>{0,126})/([<a
href="A-Za-z0-9!#$&^_.+-">A-Za-z0-9]</a>{0,126}) *$/;</p>
...
<pre>if (typeof obj.getHeader === &#39;function&#39;) {
  // res-like
...
return &#39;&quot;&#39; + str.replace(quoteRegExp, &#39;\\$1&#39;) + &#39;&quot;&#39;</pre>

<p>}</p>

<p>/**</p>

<pre> Simply &quot;type/subtype+siffx&quot; into parts.
...
<p>function splitType(string) {</p>

<pre>var match = typeRegExp.exec(string.toLowerCase())
