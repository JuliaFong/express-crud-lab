...
<div class="nav-section">
  ...
  <ul class="link-list" role="directory">
    <li><a href="#label-encodeurl">encodeurl</a>
    <li><a href="#label-Installation">Installation</a>
    <li><a href="#label-API">API</a>
    <li><a href="#label-encodeUrl-28url-29">encodeUrl(url)</a>
    <li><a href="#label-Examples">Examples</a>
    <li><a href="#label-Encode+a+URL+containing+user-controled+data">Encode a URL containing user-controled data</a>
    <li><a href="#label-Encode+a+URL+for+use+in+a+header+field">Encode a URL for use in a header field</a>
...
<main role="main" aria-label="Page node_modules/encodeurl/README.md">

<h1 id="label-encodeurl">encodeurl<span><a href="#label-encodeurl">&para;</a> <a href="#top">&uarr;</a></span></h1>

<p><a href="https://npmjs.org/package/encodeurl"><img
src="https://img.shields.io/npm/v/encodeurl.svg"></a> <a
href="https://npmjs.org/package/encodeurl"><img
src="https://img.shields.io/npm/dm/encodeurl.svg"></a> <a
href="https://nodejs.org/en/download"><img
src="https://img.shields.io/node/v/encodeurl.svg"></a> <a
href="https://travis-ci.org/pillarjs/encodeurl"><img
src="https://img.shields.io/travis/pillarjs/encodeurl.svg"></a> <a
href="https://coveralls.io/r/pillarjs/encodeurl?branch=master"><img
src="https://img.shields.io/coveralls/pillarjs/encodeurl.svg"></a></p>
...
<pre class="ruby"><span class="ruby-identifier">var</span> <span class="ruby-identifier">encodeUrl</span> = <span class="ruby-identifier">require</span>(<span class="ruby-string">&#39;encodeurl&#39;</span>)
</pre>

<h3 id="label-encodeUrl-28url-29">encodeUrl(url)<span><a href="#label-encodeUrl-28url-29">&para;</a> <a href="#top">&uarr;</a></span></h3>

<p>Encode a URL to a percent-encoded form, excluding already-encoded
sequences.</p>

<p>This function will take an already-encoded URL and encode all the non-URL
code points (as UTF-8 byte sequences). This function will not encode the
“%” character unless it is not part of a valid sequence (<code>%20</code>
will be left as-is, but <code>%foo</code> will be encoded as
<code>%25foo</code>).</p>

<p>This encode is meant to be “safe” and does not throw errors. It will try as
hard as it can to properly encode the given URL, including replacing any
raw, unpaired surrogate pairs with the Unicode replacement character prior
to encoding.</p>

<p>This function is <em>similar</em> to the intrinsic function
<code>encodeURI</code>, except it will not encode the <code>%</code>
character if that is part of a valid sequence, will not encode
<code>[</code> and <code>]</code> (for IPv6 hostnames) and will replace
...
<h3 id="label-Encode+a+URL+containing+user-controled+data">Encode a URL containing user-controled data<span><a href="#label-Encode+a+URL+containing+user-controled+data">&para;</a> <a href="#top">&uarr;</a></span></h3>

<pre>var encodeUrl = require(&#39;encodeurl&#39;)
...
<h3 id="label-Encode+a+URL+for+use+in+a+header+field">Encode a URL for use in a header field<span><a href="#label-Encode+a+URL+for+use+in+a+header+field">&para;</a> <a href="#top">&uarr;</a></span></h3>
...
<ul><li>
<p><a href="https://tools.ietf.org/html/rfc3986">RFC 3986: Uniform Resource
Identifier (URI): Generic Syntax</a></p>
</li><li>
<p><a href="https://url.spec.whatwg.org/">WHATWG URL Living Standard</a></p>
</li></ul>
