...
<main role="main" aria-label="Page node_modules/depd/lib/compat/index.js">
...
<p>lazyProperty(module.exports, &#39;callSiteToString&#39;, function
callSiteToString () {</p>

<pre>var limit = Error.stackTraceLimit
var obj = {}
...
return stack[0].toString ? toString : require(&#39;./callsite-tostring&#39;)</pre>

<p>})</p>

<p>lazyProperty(module.exports, &#39;eventListenerCount&#39;, function
eventListenerCount () {</p>

<pre class="ruby"><span class="ruby-keyword">return</span> <span class="ruby-constant">EventEmitter</span>.<span class="ruby-identifier">listenerCount</span> <span class="ruby-operator">||</span> <span class="ruby-identifier">require</span>(<span class="ruby-string">&#39;./event-listener-count&#39;</span>)
</pre>
...
<pre class="ruby"> <span class="ruby-constant">Define</span> <span class="ruby-identifier">a</span> <span class="ruby-identifier">lazy</span> <span class="ruby-identifier">property</span>.
<span class="ruby-operator">/</span>
</pre>

<p>function lazyProperty (obj, prop, getter) {</p>

<pre class="ruby"><span class="ruby-identifier">function</span> <span class="ruby-identifier">get</span> () {
  <span class="ruby-identifier">var</span> <span class="ruby-identifier">val</span> = <span class="ruby-identifier">getter</span>()

  <span class="ruby-constant">Object</span>.<span class="ruby-identifier">defineProperty</span>(<span class="ruby-identifier">obj</span>, <span class="ruby-identifier">prop</span>, {
    <span class="ruby-identifier">configurable</span><span class="ruby-operator">:</span> <span class="ruby-keyword">true</span>,
    <span class="ruby-identifier">enumerable</span><span class="ruby-operator">:</span> <span class="ruby-keyword">true</span>,
...
<span class="ruby-constant">Object</span>.<span class="ruby-identifier">defineProperty</span>(<span class="ruby-identifier">obj</span>, <span class="ruby-identifier">prop</span>, {
  <span class="ruby-identifier">configurable</span><span class="ruby-operator">:</span> <span class="ruby-keyword">true</span>,
  <span class="ruby-identifier">enumerable</span><span class="ruby-operator">:</span> <span class="ruby-keyword">true</span>,
  <span class="ruby-identifier">get</span><span class="ruby-operator">:</span> <span class="ruby-identifier">get</span>
})
</pre>
...
<pre> Call toString() on the obj
/</pre>

<p>function toString (obj) {</p>

<pre class="ruby"><span class="ruby-keyword">return</span> <span class="ruby-identifier">obj</span>.<span class="ruby-identifier">toString</span>()
</pre>
