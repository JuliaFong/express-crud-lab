...
<title>express.js - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/express/lib/express.js">
...
<pre class="ruby"> <span class="ruby-constant">Module</span> <span class="ruby-identifier">dependencies</span>.
<span class="ruby-operator">/</span>
</pre>

<p>var bodyParser = require(&#39;body-parser&#39;) var EventEmitter =
require(&#39;events&#39;).EventEmitter; var mixin =
require(&#39;merge-descriptors&#39;); var proto =
require(&#39;./application&#39;); var Route =
require(&#39;./router/route&#39;); var Router =
require(&#39;./router&#39;); var req = require(&#39;./request&#39;); var
res = require(&#39;./response&#39;);</p>

<p>/**</p>

<pre class="ruby"> <span class="ruby-constant">Expose</span> <span class="ruby-value">%x`createApplication()`</span>.
<span class="ruby-operator">/</span>
</pre>
...
<pre> Create an express application.

 @return {Function}
 @api public
/</pre>

<p>function createApplication() {</p>

<pre>var app = function(req, res, next) {
...
<pre class="ruby"> <span class="ruby-constant">Expose</span> <span class="ruby-identifier">the</span> <span class="ruby-identifier">prototypes</span>.
<span class="ruby-operator">/</span>
</pre>

<p>exports.application = proto; exports.request = req; exports.response = res;</p>

<p>/**</p>

<pre class="ruby"> <span class="ruby-constant">Expose</span> <span class="ruby-identifier">constructors</span>.
<span class="ruby-operator">/</span>
</pre>

<p>exports.Route = Route; exports.Router = Router;</p>

<p>/**</p>

<pre> Expose middleware
/</pre>

<p>exports.json = bodyParser.json exports.query =
require(&#39;./middleware/query&#39;); exports.raw = bodyParser.raw
exports.static = require(&#39;serve-static&#39;); exports.text =
bodyParser.text exports.urlencoded = bodyParser.urlencoded</p>

<p>/**</p>

<pre class="ruby"> <span class="ruby-constant">Replace</span> <span class="ruby-identifier">removed</span> <span class="ruby-identifier">middleware</span> <span class="ruby-identifier">with</span> <span class="ruby-identifier">an</span> <span class="ruby-identifier">appropriate</span> <span class="ruby-identifier">error</span> <span class="ruby-identifier">message</span>.
<span class="ruby-operator">/</span>
</pre>

<p>var removedMiddlewares = [</p>
...
<p>removedMiddlewares.forEach(function (name) {</p>

<pre>Object.defineProperty(exports, name, {
  get: function () {
