...
<main role="main" aria-label="Page node_modules/encodeurl/index.js">
...
<p>module.exports = encodeUrl</p>

<p>/**</p>

<pre> RegExp to match non-URL code points, *after* encoding (i.e. not including &quot;%&quot;)
 and including invalid escape sequences.
 @private
/</pre>

<p>var ENCODE_CHARS_REGEXP = /(?:[^<a
href=“^0-9A-Fa-f”>x21x25x26-x3Bx3Dx3F-x5Bx5Dx5Fx61-x7Ax7E]|%(?:</a>|[<a
href="^0-9A-Fa-f">0-9A-Fa-f]</a>|$))+/g</p>

<p>/**</p>

<pre> RegExp to match unmatched surrogate pair.
 @private
/</pre>

<p>var UNMATCHED_SURROGATE_PAIR_REGEXP = /(^|[^<a
href=“uDC00-uDFFF”>uD800-uDBFF])</a>|[<a
href=“^uDC00-uDFFF”>uD800-uDBFF](</a>|$)/g</p>

<p>/**</p>

<pre> String to replace unmatched surrogate pair with.
 @private
/</pre>

<p>var UNMATCHED_SURROGATE_PAIR_REPLACE = &#39;$1uFFFD$2&#39;</p>

<p>/**</p>

<pre> Encode a URL to a percent-encoded form, excluding already-encoded sequences.
...
<p>function encodeUrl (url) {</p>

<pre class="ruby"><span class="ruby-keyword">return</span> <span class="ruby-constant">String</span>(<span class="ruby-identifier">url</span>)
  .<span class="ruby-identifier">replace</span>(<span class="ruby-constant">UNMATCHED_SURROGATE_PAIR_REGEXP</span>, <span class="ruby-constant">UNMATCHED_SURROGATE_PAIR_REPLACE</span>)
  .<span class="ruby-identifier">replace</span>(<span class="ruby-constant">ENCODE_CHARS_REGEXP</span>, <span class="ruby-identifier">encodeURI</span>)
</pre>
