...
<div class="nav-section">
  ...
  <ul class="link-list" role="directory">
    <li><a href="#label-on-finished">on-finished</a>
    <li><a href="#label-Install">Install</a>
    <li><a href="#label-API">API</a>
    <li><a href="#label-onFinished-28res-2C+listener-29">onFinished(res, listener)</a>
    <li><a href="#label-onFinished-28req-2C+listener-29">onFinished(req, listener)</a>
    <li><a href="#label-onFinished.isFinished-28res-29">onFinished.isFinished(res)</a>
    <li><a href="#label-onFinished.isFinished-28req-29">onFinished.isFinished(req)</a>
    <li><a href="#label-Special+Node.js+requests">Special Node.js requests</a>
    <li><a href="#label-HTTP+CONNECT+method">HTTP CONNECT method</a>
    <li><a href="#label-HTTP+Upgrade+request">HTTP Upgrade request</a>
...
<main role="main" aria-label="Page node_modules/on-finished/README.md">

<h1 id="label-on-finished">on-finished<span><a href="#label-on-finished">&para;</a> <a href="#top">&uarr;</a></span></h1>

<p><a href="https://npmjs.org/package/on-finished"><img
src="https://img.shields.io/npm/v/on-finished.svg"></a> <a
href="https://npmjs.org/package/on-finished"><img
src="https://img.shields.io/npm/dm/on-finished.svg"></a> <a
href="http://nodejs.org/download/"><img
src="https://img.shields.io/node/v/on-finished.svg"></a> <a
href="https://travis-ci.org/jshttp/on-finished"><img
src="https://img.shields.io/travis/jshttp/on-finished/master.svg"></a> <a
href="https://coveralls.io/r/jshttp/on-finished?branch=master"><img
src="https://img.shields.io/coveralls/jshttp/on-finished/master.svg"></a></p>
...
<pre>$ npm install on-finished</pre>

<h2 id="label-API">API<span><a href="#label-API">&para;</a> <a href="#top">&uarr;</a></span></h2>

<pre class="ruby"><span class="ruby-identifier">var</span> <span class="ruby-identifier">onFinished</span> = <span class="ruby-identifier">require</span>(<span class="ruby-string">&#39;on-finished&#39;</span>)
</pre>

<h3 id="label-onFinished-28res-2C+listener-29">onFinished(res, listener)<span><a href="#label-onFinished-28res-2C+listener-29">&para;</a> <a href="#top">&uarr;</a></span></h3>

<p>Attach a listener to listen for the response to finish. The listener will
be invoked only once when the response finished. If the response finished
to an error, the first argument will contain the error. If the response has
already finished, the listener will be invoked.</p>
...
<pre>onFinished(res, function (err, res) {
  // clean up open fds, etc.
  // err contains the error is request error&#39;d
})</pre>

<h3 id="label-onFinished-28req-2C+listener-29">onFinished(req, listener)<span><a href="#label-onFinished-28req-2C+listener-29">&para;</a> <a href="#top">&uarr;</a></span></h3>

<p>Attach a listener to listen for the request to finish. The listener will be
invoked only once when the request finished. If the request finished to an
error, the first argument will contain the error. If the request has
already finished, the listener will be invoked.</p>
...
<h3 id="label-onFinished.isFinished-28res-29">onFinished.isFinished(res)<span><a href="#label-onFinished.isFinished-28res-29">&para;</a> <a href="#top">&uarr;</a></span></h3>

<p>Determine if <code>res</code> is already finished. This would be useful to
check and not even start certain operations if the response has already
finished.</p>

<h3 id="label-onFinished.isFinished-28req-29">onFinished.isFinished(req)<span><a href="#label-onFinished.isFinished-28req-29">&para;</a> <a href="#top">&uarr;</a></span></h3>

<p>Determine if <code>req</code> is already finished. This would be useful to
check and not even start certain operations if the request has already
finished.</p>

<h2 id="label-Special+Node.js+requests">Special Node.js requests<span><a href="#label-Special+Node.js+requests">&para;</a> <a href="#top">&uarr;</a></span></h2>

<h3 id="label-HTTP+CONNECT+method">HTTP CONNECT method<span><a href="#label-HTTP+CONNECT+method">&para;</a> <a href="#top">&uarr;</a></span></h3>

<p>The meaning of the <code>CONNECT</code> method from RFC 7231, section
4.3.6:</p>

<blockquote>
<p>The CONNECT method requests that the recipient establish a tunnel to the
...
<p>In Node.js, these request objects come from the
<code>&#39;connect&#39;</code> event on the HTTP server.</p>

<p>When this module is used on a HTTP <code>CONNECT</code> request, the
request is considered “finished” immediately, <strong>due to limitations in
the Node.js interface</strong>. This means if the <code>CONNECT</code>
request contains a request entity, the request will be considered
“finished” even before it has been read.</p>

<p>There is no such thing as a response object to a <code>CONNECT</code>
request in Node.js, so there is no support for for one.</p>

<h3 id="label-HTTP+Upgrade+request">HTTP Upgrade request<span><a href="#label-HTTP+Upgrade+request">&para;</a> <a href="#top">&uarr;</a></span></h3>

<p>The meaning of the <code>Upgrade</code> header from RFC 7230, section 6.1:</p>

<blockquote>
<p>The “Upgrade” header field is intended to provide a simple mechanism for
transitioning from HTTP/1.1 to some other protocol on the same connection.</p>
</blockquote>

<p>In Node.js, these request objects come from the
<code>&#39;upgrade&#39;</code> event on the HTTP server.</p>

<p>When this module is used on a HTTP request with an <code>Upgrade</code>
header, the request is considered “finished” immediately, <strong>due to
limitations in the Node.js interface</strong>. This means if the
<code>Upgrade</code> request contains a request entity, the request will be
considered “finished” even before it has been read.</p>

<p>There is no such thing as a response object to a <code>Upgrade</code>
request in Node.js, so there is no support for for one.</p>

<h2 id="label-Example">Example<span><a href="#label-Example">&para;</a> <a href="#top">&uarr;</a></span></h2>

<p>The following code ensures that file descriptors are always closed once the
response finishes.</p>

<pre>var destroy = require(&#39;destroy&#39;)
