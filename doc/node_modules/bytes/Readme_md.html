...
<div class="nav-section">
  ...
  <ul class="link-list" role="directory">
    <li><a href="#label-Bytes+utility">Bytes utility</a>
    <li><a href="#label-Installation">Installation</a>
    <li><a href="#label-Usage">Usage</a>
    <li><a href="#label-bytes.format-28number+value-2C+-5Boptions-5D-29-3A+string-EF-BD-9Cnull">bytes.format(number value, [options]): string｜null</a>
    <li><a href="#label-bytes.parse-28string-EF-BD-9Cnumber+value-29-3A+number-EF-BD-9Cnull">bytes.parse(string｜number value): number｜null</a>
...
<main role="main" aria-label="Page node_modules/bytes/Readme.md">

<h1 id="label-Bytes+utility">Bytes utility<span><a href="#label-Bytes+utility">&para;</a> <a href="#top">&uarr;</a></span></h1>

<p><a href="https://npmjs.org/package/bytes"><img
src="https://badgen.net/npm/node/bytes"></a> <a
href="https://npmjs.org/package/bytes"><img
src="https://badgen.net/npm/dm/bytes"></a> <a
href="https://travis-ci.org/visionmedia/bytes.js"><img
src="https://badgen.net/travis/visionmedia/bytes.js/master"></a> <a
href="https://coveralls.io/r/visionmedia/bytes.js?branch=master"><img
src="https://badgen.net/coveralls/c/github/visionmedia/bytes.js/master"></a></p>

<p>Utility to parse a string bytes (ex: <code>1TB</code>) to bytes
(<code>1099511627776</code>) and vice-versa.</p>
...
<pre>$ npm install bytes</pre>

<h2 id="label-Usage">Usage<span><a href="#label-Usage">&para;</a> <a href="#top">&uarr;</a></span></h2>

<pre class="ruby"><span class="ruby-identifier">var</span> <span class="ruby-identifier">bytes</span> = <span class="ruby-identifier">require</span>(<span class="ruby-string">&#39;bytes&#39;</span>);
</pre>

<h4 id="label-bytes.format-28number+value-2C+-5Boptions-5D-29-3A+string-EF-BD-9Cnull">bytes.format(number value, [options]): string｜null<span><a href="#label-bytes.format-28number+value-2C+-5Boptions-5D-29-3A+string-EF-BD-9Cnull">&para;</a> <a href="#top">&uarr;</a></span></h4>

<p>Format the given value in bytes into a string. If the value is negative, it
is kept as such. If it is a float, it is  rounded.</p>

<p><strong>Arguments</strong></p>

<p>| Name | Type | Description | |———|———-|——————–| | value |
<code>number</code> | Value in bytes | | options | <code>Object</code> |
...
|——————-|——–|—————————————————————————————–| | decimalPlaces |
<code>number</code>｜<code>null</code> | Maximum number of decimal places to
include in output. Default value to <code>2</code>. | | fixedDecimals |
<code>boolean</code>｜<code>null</code> | Whether to always display the
maximum number of decimal places. Default value to <code>false</code> | |
thousandsSeparator | <code>string</code>｜<code>null</code> | Example of
values: <code>&#39; &#39;</code>, <code>&#39;,&#39;</code> and
<code>.</code>… Default value to <code>&#39;&#39;</code>. | | unit |
<code>string</code>｜<code>null</code> | The unit in which the result will
be returned (B/KB/MB/GB/TB). Default value to <code>&#39;&#39;</code>
(which means auto detect). | | unitSeparator |
<code>string</code>｜<code>null</code> | Separator to use between number and
unit. Default value to <code>&#39;&#39;</code>. |</p>

<p><strong>Returns</strong></p>

<p>| Name | Type | Description | |———|——————|————————————————-| | results |
<code>string</code>｜<code>null</code> | Return null upon error. String
value otherwise. |</p>
...
<h4 id="label-bytes.parse-28string-EF-BD-9Cnumber+value-29-3A+number-EF-BD-9Cnull">bytes.parse(string｜number value): number｜null<span><a href="#label-bytes.parse-28string-EF-BD-9Cnumber+value-29-3A+number-EF-BD-9Cnull">&para;</a> <a href="#top">&uarr;</a></span></h4>

<p>Parse the string value into an integer in bytes. If no unit is given, or
<code>value</code> is a number, it is assumed the value is in bytes.</p>
...
<p><code>pb</code> for petabytes</p>
</li></ul>

<p>The units are in powers of two, not ten. This means 1kb = 1024b according
to this parser.</p>

<p><strong>Arguments</strong></p>

<p>| Name | Type | Description | |—————|——–|——————–| | value |
<code>string</code>｜<code>number</code> | String to parse, or number in
bytes. |</p>

<p><strong>Returns</strong></p>

<p>| Name | Type | Description | |———|————-|————————-| | results |
<code>number</code>｜<code>null</code> | Return null upon error. Value in
bytes otherwise. |</p>
