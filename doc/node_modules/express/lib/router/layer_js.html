...
<title>layer.js - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/express/lib/router/layer.js">
...
<p>var pathRegexp = require(&#39;path-to-regexp&#39;); var debug =
require(&#39;debug&#39;)(&#39;express:router:layer&#39;);</p>
...
<p>var hasOwnProperty = Object.prototype.hasOwnProperty;</p>
...
<p>module.exports = Layer;</p>

<p>function Layer(path, options, fn) {</p>

<pre>if (!(this instanceof Layer)) {
...
this.regexp.fast_slash = path === &#39;/&#39; &amp;&amp; opts.end === false</pre>

<p>}</p>

<p>/**</p>

<pre> Handle the error for the layer.
...
<p>Layer.prototype.handle_error = function handle_error(error, req, res, next)
{</p>

<pre>var fn = this.handle;
...
<pre> Handle the request for the layer.
...
<p>Layer.prototype.handle_request = function handle(req, res, next) {</p>
...
<pre> Check if this route matches `path`, if so
 populate `.params`.
...
<p>Layer.prototype.match = function match(path) {</p>
...
<p>function decode_param(val) {</p>

<pre>if (typeof val !== &#39;string&#39; || val.length === 0) {
  return val;
}
