...
<main role="main" aria-label="Page node_modules/range-parser/index.js">
...
<p>module.exports = rangeParser</p>

<p>/**</p>

<pre> Parse &quot;Range&quot; header `str` relative to the given file `size`.
...
<p>function rangeParser (size, str, options) {</p>

<pre>if (typeof str !== &#39;string&#39;) {
...
<pre> Combine overlapping &amp; adjacent ranges.
 @private
/</pre>

<p>function combineRanges (ranges) {</p>

<pre>var ordered = ranges.map(mapWithIndex).sort(sortByRangeStart)
...
<pre> Map function to add index value to ranges.
 @private
/</pre>

<p>function mapWithIndex (range, index) {</p>

<pre class="ruby"><span class="ruby-keyword">return</span> {
  <span class="ruby-identifier">start</span><span class="ruby-operator">:</span> <span class="ruby-identifier">range</span>.<span class="ruby-identifier">start</span>,
  <span class="ruby-keyword">end</span><span class="ruby-operator">:</span> <span class="ruby-identifier">range</span>.<span class="ruby-identifier">end</span>,
  <span class="ruby-identifier">index</span><span class="ruby-operator">:</span> <span class="ruby-identifier">index</span>
}
</pre>
...
<pre> Map function to remove index value from ranges.
 @private
/</pre>

<p>function mapWithoutIndex (range) {</p>
...
<pre> Sort function to sort ranges by index.
 @private
/</pre>

<p>function sortByRangeIndex (a, b) {</p>

<pre class="ruby"><span class="ruby-keyword">return</span> <span class="ruby-identifier">a</span>.<span class="ruby-identifier">index</span> <span class="ruby-operator">-</span> <span class="ruby-identifier">b</span>.<span class="ruby-identifier">index</span>
</pre>
...
<pre> Sort function to sort ranges by start position.
 @private
/</pre>

<p>function sortByRangeStart (a, b) {</p>

<pre class="ruby"><span class="ruby-keyword">return</span> <span class="ruby-identifier">a</span>.<span class="ruby-identifier">start</span> <span class="ruby-operator">-</span> <span class="ruby-identifier">b</span>.<span class="ruby-identifier">start</span>
</pre>
