...
<title>charset.js - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/negotiator/lib/charset.js">
...
<p>module.exports = preferredCharsets; module.exports.preferredCharsets =
preferredCharsets;</p>
...
<p>var simpleCharsetRegExp = /^<a href=“^s;”>s*(</a>+)s*(?:;(.*))?$/;</p>

<p>/**</p>

<pre> Parse the Accept-Charset header.
 @private
/</pre>

<p>function parseAcceptCharset(accept) {</p>
...
<pre> Parse a charset from the Accept-Charset header.
 @private
/</pre>

<p>function parseCharset(str, i) {</p>

<pre>var match = simpleCharsetRegExp.exec(str);
...
<pre> Get the priority of a charset.
 @private
/</pre>

<p>function getCharsetPriority(charset, accepted, index) {</p>
...
<pre> Get the specificity of the charset.
 @private
/</pre>

<p>function specify(charset, spec, index) {</p>
...
<pre> Get the preferred charsets from an Accept-Charset header.
 @public
/</pre>

<p>function preferredCharsets(accept, provided) {</p>
...
<pre> Get full charset string.
 @private
/</pre>

<p>function getFullCharset(spec) {</p>

<pre class="ruby"><span class="ruby-keyword">return</span> <span class="ruby-identifier">spec</span>.<span class="ruby-identifier">charset</span>;
</pre>
