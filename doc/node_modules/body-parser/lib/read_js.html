...
<title>read.js - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/body-parser/lib/read.js">
...
<p>var createError = require(&#39;http-errors&#39;) var getBody =
require(&#39;raw-body&#39;) var iconv = require(&#39;iconv-lite&#39;) var
onFinished = require(&#39;on-finished&#39;) var zlib =
require(&#39;zlib&#39;)</p>
...
<p>module.exports = read</p>

<p>/**</p>

<pre> Read a request into a buffer and parse.
...
<p>function read (req, res, next, parse, debug, options) {</p>
...
<pre> Get the content stream of the request.
...
<p>function contentstream (req, debug, inflate) {</p>

<pre>var encoding = (req.headers[&#39;content-encoding&#39;] || &#39;identity&#39;).toLowerCase()
