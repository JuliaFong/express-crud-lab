...
<main role="main" aria-label="Page node_modules/cookie/index.js">
...
<p>exports.parse = parse; exports.serialize = serialize;</p>
...
<p>var decode = decodeURIComponent; var encode = encodeURIComponent; var
pairSplitRegExp = /;   ;</p>

<p>/**</p>

<pre> RegExp to match field-content in RFC 7230 sec 3.2
...
<p>var fieldContentRegExp = /^[u0009u0020-u007eu0080-u00ff]+$/;</p>

<p>/**</p>

<pre> Parse a cookie header.
...
<p>function parse(str, options) {</p>
...
<pre> Serialize data into a cookie header.
...
<p>function serialize(name, val, options) {</p>
...
<pre> Try decoding a string using a decoding function.
...
<p>function tryDecode(str, decode) {</p>
