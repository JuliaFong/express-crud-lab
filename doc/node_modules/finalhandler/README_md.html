...
<div class="nav-section">
  ...
  <ul class="link-list" role="directory">
    <li><a href="#label-finalhandler">finalhandler</a>
    <li><a href="#label-Installation">Installation</a>
    <li><a href="#label-API">API</a>
    <li><a href="#label-finalhandler-28req-2C+res-2C+-5Boptions-5D-29">finalhandler(req, res, [options])</a>
    <li><a href="#label-options.env">options.env</a>
    <li><a href="#label-options.onerror">options.onerror</a>
    <li><a href="#label-Examples">Examples</a>
    <li><a href="#label-always+404">always 404</a>
    <li><a href="#label-perform+simple+action">perform simple action</a>
    <li><a href="#label-use+with+middleware-style+functions">use with middleware-style functions</a>
    <li><a href="#label-keep+log+of+all+errors">keep log of all errors</a>
...
<main role="main" aria-label="Page node_modules/finalhandler/README.md">

<h1 id="label-finalhandler">finalhandler<span><a href="#label-finalhandler">&para;</a> <a href="#top">&uarr;</a></span></h1>

<p><a href="https://npmjs.org/package/finalhandler"><img
src="https://img.shields.io/npm/v/finalhandler.svg"></a> <a
href="https://npmjs.org/package/finalhandler"><img
src="https://img.shields.io/npm/dm/finalhandler.svg"></a> <a
href="https://nodejs.org/en/download"><img
src="https://img.shields.io/node/v/finalhandler.svg"></a> <a
href="https://travis-ci.org/pillarjs/finalhandler"><img
src="https://img.shields.io/travis/pillarjs/finalhandler.svg"></a> <a
href="https://coveralls.io/r/pillarjs/finalhandler?branch=master"><img
src="https://img.shields.io/coveralls/pillarjs/finalhandler.svg"></a></p>
...
<pre>$ npm install finalhandler</pre>

<h2 id="label-API">API<span><a href="#label-API">&para;</a> <a href="#top">&uarr;</a></span></h2>
<!-- eslint-disable no-unused-vars -->
<pre class="ruby"><span class="ruby-identifier">var</span> <span class="ruby-identifier">finalhandler</span> = <span class="ruby-identifier">require</span>(<span class="ruby-string">&#39;finalhandler&#39;</span>)
</pre>

<h3 id="label-finalhandler-28req-2C+res-2C+-5Boptions-5D-29">finalhandler(req, res, [options])<span><a href="#label-finalhandler-28req-2C+res-2C+-5Boptions-5D-29">&para;</a> <a href="#top">&uarr;</a></span></h3>

<p>Returns function to be invoked as the final step for the given
<code>req</code> and <code>res</code>. This function is to be invoked as
<code>fn(err)</code>. If <code>err</code> is falsy, the handler will write
out a 404 response to the <code>res</code>. If it is truthy, an error
response will be written out to the <code>res</code>.</p>

<p>When an error is written, the following information is added to the
response:</p>
<ul><li>
<p>The <code>res.statusCode</code> is set from <code>err.status</code> (or
<code>err.statusCode</code>). If this value is outside the 4xx or 5xx
range, it will be set to 500.</p>
</li><li>
<p>The <code>res.statusMessage</code> is set according to the status code.</p>
</li><li>
<p>The body will be the HTML of the status code message if <code>env</code> is
<code>&#39;production&#39;</code>, otherwise will be
<code>err.stack</code>.</p>
</li><li>
<p>Any headers specified in an <code>err.headers</code> object.</p>
</li></ul>

<p>The final handler will also unpipe anything from <code>req</code> when it
is invoked.</p>

<h4 id="label-options.env">options.env<span><a href="#label-options.env">&para;</a> <a href="#top">&uarr;</a></span></h4>

<p>By default, the environment is determined by <code>NODE_ENV</code>
variable, but it can be overridden by this option.</p>

<h4 id="label-options.onerror">options.onerror<span><a href="#label-options.onerror">&para;</a> <a href="#top">&uarr;</a></span></h4>

<p>Provide a function to be called with the <code>err</code> when it exists.
Can be used for writing errors to a central location without excessive
function generation. Called as <code>onerror(err, req, res)</code>.</p>

<h2 id="label-Examples">Examples<span><a href="#label-Examples">&para;</a> <a href="#top">&uarr;</a></span></h2>

<h3 id="label-always+404">always 404<span><a href="#label-always+404">&para;</a> <a href="#top">&uarr;</a></span></h3>

<pre>var finalhandler = require(&#39;finalhandler&#39;)
...
<h3 id="label-perform+simple+action">perform simple action<span><a href="#label-perform+simple+action">&para;</a> <a href="#top">&uarr;</a></span></h3>
...
<h3 id="label-use+with+middleware-style+functions">use with middleware-style functions<span><a href="#label-use+with+middleware-style+functions">&para;</a> <a href="#top">&uarr;</a></span></h3>
...
<h3 id="label-keep+log+of+all+errors">keep log of all errors<span><a href="#label-keep+log+of+all+errors">&para;</a> <a href="#top">&uarr;</a></span></h3>
