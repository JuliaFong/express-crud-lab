...
<title>dangerous.js - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/safer-buffer/dangerous.js">

<pre>eslint-disable node/no-deprecated-api</pre>

<p>&#39;use strict&#39;</p>

<p>var buffer = require(&#39;buffer&#39;) var Buffer = buffer.Buffer var safer
= require(&#39;./safer.js&#39;) var Safer = safer.Buffer</p>

<p>var dangerous = {}</p>

<p>var key</p>

<p>for (key in safer) {</p>

<pre>if (!safer.hasOwnProperty(key)) continue
dangerous[key] = safer[key]</pre>

<p>}</p>

<p>var Dangereous = dangerous.Buffer = {}</p>

<p>// Copy Safer API for (key in Safer) {</p>

<pre>if (!Safer.hasOwnProperty(key)) continue
Dangereous[key] = Safer[key]</pre>

<p>}</p>

<p>// Copy those missing unsafe methods, if they are present for (key in
Buffer) {</p>

<pre>if (!Buffer.hasOwnProperty(key)) continue
if (Dangereous.hasOwnProperty(key)) continue
Dangereous[key] = Buffer[key]</pre>

<p>}</p>

<p>if (!Dangereous.allocUnsafe) {</p>

<pre>Dangereous.allocUnsafe = function (size) {
...
<p>if (!Dangereous.allocUnsafeSlow) {</p>

<pre>Dangereous.allocUnsafeSlow = function (size) {
  if (typeof size !== &#39;number&#39;) {
    throw new TypeError(&#39;The &quot;size&quot; argument must be of type number. Received type &#39; + typeof size)
  }
  if (size &lt; 0 || size &gt;= 2 * (1 &lt;&lt; 30)) {
