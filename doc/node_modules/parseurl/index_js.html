...
<main role="main" aria-label="Page node_modules/parseurl/index.js">
...
<p>var url = require(&#39;url&#39;) var parse = url.parse var Url = url.Url</p>
...
<p>module.exports = parseurl module.exports.original = originalurl</p>

<p>/**</p>

<pre> Parse the `req` url with memoization.
...
return (req._parsedUrl = parsed)</pre>

<p>};</p>

<p>/**</p>

<pre> Parse the `req` original url with fallback and memoization.
...
<p>function originalurl (req) {</p>

<pre>var url = req.originalUrl
...
return (req._parsedOriginalUrl = parsed)</pre>

<p>};</p>

<p>/**</p>

<pre> Parse the `str` url with fast-path short-cut.
...
<p>function fastparse (str) {</p>

<pre>if (typeof str !== &#39;string&#39; || str.charCodeAt(0) !== 0x2f /* /   ) {
  return parse(str)
}
...
<pre> Determine if parsed is still fresh for url.
...
<p>function fresh (url, parsedUrl) {</p>

<pre>return typeof parsedUrl === &#39;object&#39; &amp;&amp;
  parsedUrl !== null &amp;&amp;
  (Url === undefined || parsedUrl instanceof Url) &amp;&amp;
  parsedUrl._raw === url</pre>
