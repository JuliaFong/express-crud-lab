...
<main role="main" aria-label="Page node_modules/forwarded/index.js">
...
<p>module.exports = forwarded</p>

<p>/**</p>

<pre> Get all addresses in the request, using the `X-Forwarded-For` header.
...
<pre> Parse the X-Forwarded-For header.
