...
<div class="nav-section">
  ...
  <ul class="link-list" role="directory">
    <li><a href="#label-forwarded">forwarded</a>
    <li><a href="#label-Installation">Installation</a>
    <li><a href="#label-API">API</a>
    <li><a href="#label-forwarded-28req-29">forwarded(req)</a>
...
<main role="main" aria-label="Page node_modules/forwarded/README.md">

<h1 id="label-forwarded">forwarded<span><a href="#label-forwarded">&para;</a> <a href="#top">&uarr;</a></span></h1>

<p><a href="https://npmjs.org/package/forwarded"><img
src="https://img.shields.io/npm/v/forwarded.svg"></a> <a
href="https://npmjs.org/package/forwarded"><img
src="https://img.shields.io/npm/dm/forwarded.svg"></a> <a
href="https://nodejs.org/en/download/"><img
src="https://img.shields.io/node/v/forwarded.svg"></a> <a
href="https://travis-ci.org/jshttp/forwarded"><img
src="https://img.shields.io/travis/jshttp/forwarded/master.svg"></a> <a
href="https://coveralls.io/r/jshttp/forwarded?branch=master"><img
src="https://img.shields.io/coveralls/jshttp/forwarded/master.svg"></a></p>
...
<pre class="ruby"><span class="ruby-identifier">var</span> <span class="ruby-identifier">forwarded</span> = <span class="ruby-identifier">require</span>(<span class="ruby-string">&#39;forwarded&#39;</span>)
</pre>

<h3 id="label-forwarded-28req-29">forwarded(req)<span><a href="#label-forwarded-28req-29">&para;</a> <a href="#top">&uarr;</a></span></h3>

<pre class="ruby"><span class="ruby-identifier">var</span> <span class="ruby-identifier">addresses</span> = <span class="ruby-identifier">forwarded</span>(<span class="ruby-identifier">req</span>)
</pre>

<p>Parse the <code>X-Forwarded-For</code> header from the request. Returns an
array of the addresses, including the socket address for the
<code>req</code>, in reverse order (i.e. index <code>0</code> is the socket
address and the last index is the furthest address, typically the
end-user).</p>
