...
<pre>Module dependencies.</pre>

<p>var tty = require(&#39;tty&#39;); var util = require(&#39;util&#39;);</p>
...
<p>exports = module.exports = require(&#39;./debug&#39;); exports.init = init;
exports.log = log; exports.formatArgs = formatArgs; exports.save = save;
exports.load = load; exports.useColors = useColors;</p>

<p>/**</p>

<pre class="ruby"> <span class="ruby-constant">Colors</span>.
...
<pre> The file descriptor to write the `debug()` calls to.
 Set the `DEBUG_FD` env variable to override with another value. i.e.:

   $ DEBUG_FD=3 node script.js 3&gt;debug.log
/</pre>

<p>var fd = parseInt(process.env.DEBUG_FD, 10) || 2;</p>

<p>if (1 !== fd &amp;&amp; 2 !== fd) {</p>

<pre>util.deprecate(function(){}, &#39;except for stderr(2) and stdout(1), any other usage of DEBUG_FD is deprecated. Override debug.log if you want to use a different log function (https://git.io/debug_fd)&#39;)()</pre>

<p>}</p>

<p>var stream = 1 === fd ? process.stdout :</p>

<pre class="ruby"><span class="ruby-value">2</span> <span class="ruby-operator">===</span> <span class="ruby-identifier">fd</span> <span class="ruby-operator">?</span> <span class="ruby-identifier">process</span>.<span class="ruby-identifier">stderr</span> <span class="ruby-operator">:</span>
<span class="ruby-identifier">createWritableStdioStream</span>(<span class="ruby-identifier">fd</span>);
</pre>
...
<p>exports.formatters.o = function(v) {</p>
...
<span class="ruby-keyword">return</span> <span class="ruby-identifier">util</span>.<span class="ruby-identifier">inspect</span>(<span class="ruby-identifier">v</span>, <span class="ruby-identifier">this</span>.<span class="ruby-identifier">inspectOpts</span>)
  .<span class="ruby-identifier">split</span>(<span class="ruby-string">&#39;\n&#39;</span>).<span class="ruby-identifier">map</span>(<span class="ruby-identifier">function</span>(<span class="ruby-identifier">str</span>) {
    <span class="ruby-keyword">return</span> <span class="ruby-identifier">str</span>.<span class="ruby-identifier">trim</span>()
...
<pre> Invokes `util.format()` with the specified arguments and writes to `stream`.
/</pre>
...
<pre> Copied from `node/src/node.js`.

 XXX: It&#39;s lame that node doesn&#39;t expose this API out-of-the-box. It also
 relies on the undocumented `tty_wrap.guessHandleType()` which is also lame.
/</pre>

<p>function createWritableStdioStream (fd) {</p>
...
<pre> Enable namespaces listed in `process.env.DEBUG` initially.
/</pre>

<p>exports.enable(load());</p>
</main>
