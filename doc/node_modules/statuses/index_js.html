...
<main role="main" aria-label="Page node_modules/statuses/index.js">
...
<p>var codes = require(&#39;./codes.json&#39;)</p>
...
<p>module.exports = status</p>

<p>// status code to message map status.STATUS_CODES = codes</p>

<p>// array of status codes status.codes = populateStatusesMap(status, codes)</p>

<p>// status codes for redirects status.redirect = {</p>
...
<p>// status codes for empty bodies status.empty = {</p>
...
<p>// status codes for when you should retry the request status.retry = {</p>
...
<pre> Populate the statuses map for given codes.
 @private
/</pre>

<p>function populateStatusesMap (statuses, codes) {</p>
...
<p>function status (code) {</p>

<pre>if (typeof code === &#39;number&#39;) {
