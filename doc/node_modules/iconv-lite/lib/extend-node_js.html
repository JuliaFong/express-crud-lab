...
<title>extend-node.js - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/iconv-lite/lib/extend-node.js">

<p>“use strict”; var Buffer = require(“buffer”).Buffer; // Note: not
polyfilled with safer-buffer on a purpose, as overrides Buffer</p>

<p>// == Extend Node primitives to use iconv-lite
=================================</p>

<p>module.exports = function (iconv) {</p>

<pre>var original = undefined; // Place to keep original methods.
