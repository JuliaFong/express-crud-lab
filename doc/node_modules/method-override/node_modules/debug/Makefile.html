...
<main role="main" aria-label="Page node_modules/method-override/node_modules/debug/Makefile">

<p># get <a href="../../../debug/Makefile.html">Makefile</a> directory name:
<a
...
<p>dist/debug.js: src/*.js node_modules</p>
...
<pre>@eslint *.js src/*.js</pre>

<p>test-node:</p>

<pre>@istanbul cover node_modules/mocha/bin/_mocha -- test/**.js
@cat ./coverage/lcov.info | ./node_modules/coveralls/bin/coveralls.js</pre>
...
<pre>@concurrently \
        &quot;make test-node&quot; \
        &quot;make test-browser&quot;</pre>

<p>test:</p>

<pre>@if [ &quot;x$(BROWSER)&quot; = &quot;x&quot; ]; then \
        $(MAKE) test-node; \
        else \
        $(MAKE) test-browser; \
fi</pre>
...
<pre class="ruby"><span class="ruby-identifier">rimraf</span> <span class="ruby-identifier">dist</span> <span class="ruby-identifier">coverage</span>
</pre>

<p>.PHONY: browser install clean lint test test-all test-node test-browser</p>
</main>
