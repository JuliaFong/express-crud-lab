...
<main role="main" aria-label="Page node_modules/body-parser/index.js">
...
<p>var deprecate = require(&#39;depd&#39;)(&#39;body-parser&#39;)</p>

<p>/**</p>

<pre> Cache of loaded parsers.
 @private
/</pre>
...
<p>exports = module.exports = deprecate.function(bodyParser,</p>

<pre>&#39;bodyParser: use individual json/urlencoded middlewares&#39;)</pre>
...
<p>Object.defineProperty(exports, &#39;json&#39;, {</p>

<pre>configurable: true,
enumerable: true,
get: createParserGetter(&#39;json&#39;)</pre>
...
<p>Object.defineProperty(exports, &#39;raw&#39;, {</p>

<pre>configurable: true,
enumerable: true,
get: createParserGetter(&#39;raw&#39;)</pre>
...
<p>Object.defineProperty(exports, &#39;text&#39;, {</p>

<pre>configurable: true,
enumerable: true,
get: createParserGetter(&#39;text&#39;)</pre>

<p>})</p>

<p>/**</p>

<pre> URL-encoded parser.
 @public
/</pre>

<p>Object.defineProperty(exports, &#39;urlencoded&#39;, {</p>

<pre>configurable: true,
enumerable: true,
get: createParserGetter(&#39;urlencoded&#39;)</pre>

<p>})</p>

<p>/**</p>

<pre> Create a middleware to parse json and urlencoded bodies.
...
<p>function bodyParser (options) {</p>
...
<pre> Create a getter for loading a parser.
 @private
/</pre>

<p>function createParserGetter (name) {</p>

<pre class="ruby"><span class="ruby-keyword">return</span> <span class="ruby-identifier">function</span> <span class="ruby-identifier">get</span> () {
  <span class="ruby-keyword">return</span> <span class="ruby-identifier">loadParser</span>(<span class="ruby-identifier">name</span>)
}
</pre>
...
<pre> Load a parser module.
 @private
/</pre>

<p>function loadParser (parserName) {</p>

<pre>var parser = parsers[parserName]
...
return (parsers[parserName] = parser)</pre>
