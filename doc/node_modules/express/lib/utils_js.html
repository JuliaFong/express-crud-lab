...
<main role="main" aria-label="Page node_modules/express/lib/utils.js">
...
<p>var Buffer = require(&#39;safe-buffer&#39;).Buffer var contentDisposition =
require(&#39;content-disposition&#39;); var contentType =
require(&#39;content-type&#39;); var deprecate =
require(&#39;depd&#39;)(&#39;express&#39;); var flatten =
require(&#39;array-flatten&#39;); var mime = require(&#39;send&#39;).mime;
var etag = require(&#39;etag&#39;); var proxyaddr =
require(&#39;proxy-addr&#39;); var qs = require(&#39;qs&#39;); var
querystring = require(&#39;querystring&#39;);</p>

<p>/**</p>

<pre> Return strong ETag for `body`.
...
<p>exports.etag = createETagGenerator({ weak: false })</p>

<p>/**</p>

<pre> Return weak ETag for `body`.
...
<p>exports.wetag = createETagGenerator({ weak: true })</p>

<p>/**</p>

<pre> Check if `path` looks absolute.
...
<p>exports.isAbsolute = function(path){</p>

<pre>if (&#39;/&#39; === path[0]) return true;
if (&#39;:&#39; === path[1] &amp;&amp; (&#39;\\&#39; === path[2] || &#39;/&#39; === path[2])) return true; // Windows device path
if (&#39;\\\\&#39; === path.substring(0, 2)) return true; // Microsoft Azure absolute path</pre>

<p>};</p>

<p>/**</p>

<pre> Flatten the given `arr`.
...
<p>exports.flatten = deprecate.function(flatten,</p>

<pre>&#39;utils.flatten: use array-flatten npm module instead&#39;);</pre>

<p>/**</p>

<pre> Normalize the given `type`, for example &quot;html&quot; becomes &quot;text/html&quot;.
...
<p>exports.normalizeType = function(type){</p>

<pre>return ~type.indexOf(&#39;/&#39;)
  ? acceptParams(type)
  : { value: mime.lookup(type), params: {} };</pre>

<p>};</p>

<p>/**</p>

<pre> Normalize `types`, for example &quot;html&quot; becomes &quot;text/html&quot;.
...
<p>exports.normalizeTypes = function(types){</p>
...
<pre> Generate Content-Disposition header appropriate for the filename.
...
<p>exports.contentDisposition = deprecate.function(contentDisposition,</p>

<pre>&#39;utils.contentDisposition: use content-disposition npm module instead&#39;);</pre>

<p>/**</p>

<pre> Parse accept params `str` returning an
...
<p>function acceptParams(str, index) {</p>

<pre>var parts = str.split(/ *;   );
...
<pre> Compile &quot;etag&quot; value to function.
...
<p>exports.compileETag = function(val) {</p>
...
<pre> Compile &quot;query parser&quot; value to function.
...
<p>exports.compileQueryParser = function compileQueryParser(val) {</p>
...
<pre> Compile &quot;proxy trust&quot; value to function.
...
<p>exports.compileTrust = function(val) {</p>

<pre>if (typeof val === &#39;function&#39;) return val;
...
return proxyaddr.compile(val || []);</pre>

<p>}</p>

<p>/**</p>

<pre> Set the charset in a given Content-Type string.
...
<p>exports.setCharset = function setCharset(type, charset) {</p>
...
// format type
return contentType.format(parsed);</pre>

<p>};</p>

<p>/**</p>

<pre> Create an ETag generator function, generating ETags with
 the given options.
...
<p>function createETagGenerator (options) {</p>

<pre>return function generateETag (body, encoding) {
...
<pre> Parse an extended query string with qs.

 @return {Object}
 @private
/</pre>

<p>function parseExtendedQueryString(str) {</p>

<pre class="ruby"><span class="ruby-keyword">return</span> <span class="ruby-identifier">qs</span>.<span class="ruby-identifier">parse</span>(<span class="ruby-identifier">str</span>, {
  <span class="ruby-identifier">allowPrototypes</span><span class="ruby-operator">:</span> <span class="ruby-keyword">true</span>
});
</pre>
...
<pre> Return new empty object.

 @return {Object}
 @api private
/</pre>

<p>function newObject() {</p>
