...
<div class="nav-section">
  ...
  <ul class="link-list" role="directory">
    <li><a href="#label-Destroy">Destroy</a>
    <li><a href="#label-API">API</a>
    <li><a href="#label-destroy-28stream-29">destroy(stream)</a>
...
<main role="main" aria-label="Page node_modules/destroy/README.md">

<h1 id="label-Destroy">Destroy<span><a href="#label-Destroy">&para;</a> <a href="#top">&uarr;</a></span></h1>

<p><a href="https://npmjs.org/package/destroy"><img
src="https://img.shields.io/npm/v/destroy.svg?style=flat-square"></a> <a
href="https://travis-ci.org/stream-utils/destroy"><img
src="https://img.shields.io/travis/stream-utils/destroy.svg?style=flat-square"></a>
<a href="https://coveralls.io/r/stream-utils/destroy?branch=master"><img
src="https://img.shields.io/coveralls/stream-utils/destroy.svg?style=flat-square"></a>
<a href="LICENSE.md"><img
src="http://img.shields.io/npm/l/destroy.svg?style=flat-square"></a> <a
href="https://npmjs.org/package/destroy"><img
src="http://img.shields.io/npm/dm/destroy.svg?style=flat-square"></a> <a
...
<p>This module is meant to ensure a stream gets destroyed, handling different
APIs and Node.js bugs.</p>

<h2 id="label-API">API<span><a href="#label-API">&para;</a> <a href="#top">&uarr;</a></span></h2>

<pre class="ruby"><span class="ruby-identifier">var</span> <span class="ruby-identifier">destroy</span> = <span class="ruby-identifier">require</span>(<span class="ruby-string">&#39;destroy&#39;</span>)
</pre>

<h3 id="label-destroy-28stream-29">destroy(stream)<span><a href="#label-destroy-28stream-29">&para;</a> <a href="#top">&uarr;</a></span></h3>

<p>Destroy the given stream. In most cases, this is identical to a simple
<code>stream.destroy()</code> call. The rules are as follows for a given
stream:</p>
<ol><li>
<p>If the <code>stream</code> is an instance of <code>ReadStream</code>, then
call <code>stream.destroy()</code>  and add a listener to the
<code>open</code> event to call <code>stream.close()</code> if it is 
fired. This is for a Node.js bug that will leak a file descriptor if 
<code>.destroy()</code> is called before <code>open</code>.</p>
</li><li>
<p>If the <code>stream</code> is not an instance of <code>Stream</code>, then
nothing happens.</p>
</li><li>
<p>If the <code>stream</code> has a <code>.destroy()</code> method, then call
it.</p>
</li></ol>
