...
<main role="main" aria-label="Page node_modules/depd/lib/browser/index.js">
...
<p>module.exports = depd</p>

<p>/**</p>

<pre> Create deprecate for namespace in caller.
/</pre>

<p>function depd (namespace) {</p>
...
return deprecate</pre>

<p>}</p>

<p>/**</p>

<pre> Return a wrapped function in a deprecation message.

 This is a no-op version of the wrapper, which does nothing but call
 validation.
/</pre>

<p>function wrapfunction (fn, message) {</p>
...
<pre> Wrap property in a deprecation message.

 This is a no-op version of the wrapper, which does nothing but call
 validation.
/</pre>

<p>function wrapproperty (obj, prop, message) {</p>
