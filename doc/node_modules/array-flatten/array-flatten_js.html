...
<title>array-flatten.js - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/array-flatten/array-flatten.js">

<p>&#39;use strict&#39;</p>

<pre>Expose `arrayFlatten`.</pre>

<p>module.exports = arrayFlatten</p>

<p>/**</p>

<pre> Recursive flatten function with depth.
...
<p>function flattenWithDepth (array, result, depth) {</p>
...
<pre> Recursive flatten function. Omitting depth is slightly faster.
...
<p>function flattenForever (array, result) {</p>
...
<pre> Flatten an array, with the ability to define a depth.
...
<p>function arrayFlatten (array, depth) {</p>

<pre>if (depth == null) {
  return flattenForever(array, [])
}

return flattenWithDepth(array, [], depth)</pre>
