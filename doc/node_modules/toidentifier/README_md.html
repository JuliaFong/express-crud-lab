...
<div class="nav-section">
  ...
  <ul class="link-list" role="directory">
    <li><a href="#label-toidentifier">toidentifier</a>
    <li><a href="#label-Install">Install</a>
    <li><a href="#label-Example">Example</a>
    <li><a href="#label-API">API</a>
    <li><a href="#label-toIdentifier-28string-29">toIdentifier(string)</a>
...
<main role="main" aria-label="Page node_modules/toidentifier/README.md">

<h1 id="label-toidentifier">toidentifier<span><a href="#label-toidentifier">&para;</a> <a href="#top">&uarr;</a></span></h1>

<p><a href="https://npmjs.org/package/toidentifier"><img
src="https://img.shields.io/npm/v/toidentifier.svg"></a> <a
href="https://npmjs.org/package/toidentifier"><img
src="https://img.shields.io/npm/dm/toidentifier.svg"></a> <a
href="https://travis-ci.org/component/toidentifier"><img
src="https://img.shields.io/travis/component/toidentifier/master.svg"></a>
<a href="https://codecov.io/gh/component/toidentifier"><img
src="https://img.shields.io/codecov/c/github/component/toidentifier.svg"></a></p>
...
<p>This CommonJS module exports a single default function:
<code>toIdentifier</code>.</p>

<h3 id="label-toIdentifier-28string-29">toIdentifier(string)<span><a href="#label-toIdentifier-28string-29">&para;</a> <a href="#top">&uarr;</a></span></h3>

<p>Given a string as the argument, it will be transformed according to the
following rules and the new string will be returned:</p>
<ol><li>
<p>Split into words separated by space characters (<code>0x20</code>).</p>
</li><li>
<p>Upper case the first character of each word.</p>
</li><li>
<p>Join the words together with no separator.</p>
</li><li>
<p>Remove all non-word (<code>[0-9a-z_]</code>) characters.</p>
</li></ol>
